...
INSERT INTO tb_relatorio (REL_CODIGO, FUN_CODIGO, TAG_CODIGO, REL_TITULO, REL_ATIVO, REL_AGENDADO, REL_CLASSE_RELATORIO, REL_CLASSE_PROCESSO, REL_CLASSE_AGENDAMENTO, REL_TEMPLATE_JASPER, REL_TEMPLATE_DINAMICO, REL_TEMPLATE_SUBRELATORIO, REL_TEMPLATE_SQL, REL_QTD_DIAS_LIMPEZA, REL_CUSTOMIZADO, REL_AGRUPAMENTO) VALUES('politica_privacidade', '534', NULL, 'Política de Privacidade', 1, 'N', 'com.zetra.econsig.report.reports.PoliticaPrivacidade', 'com.zetra.processamento.ProcessaPoliticaPrivacidade', NULL, 'PoliticaPrivacidade.jasper', NULL, NULL, NULL, 30, 'N', NULL);
