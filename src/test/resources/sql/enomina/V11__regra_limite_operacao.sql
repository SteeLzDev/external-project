...
insert into tb_regra_limite_operacao (RLO_CODIGO, EST_CODIGO, ORG_CODIGO, SBO_CODIGO, UNI_CODIGO, SVC_CODIGO,
                                      NSE_CODIGO, NCA_CODIGO, CSA_CODIGO, COR_CODIGO, CRS_CODIGO, CAP_CODIGO,
                                      PRS_CODIGO, POS_CODIGO, SRS_CODIGO, TRS_CODIGO, VRS_CODIGO, FUN_CODIGO,
                                      RLO_DATA_CADASTRO, RLO_DATA_VIGENCIA_INI, RLO_DATA_VIGENCIA_FIM,
                                      RLO_FAIXA_ETARIA_INI, RLO_FAIXA_ETARIA_FIM, RLO_FAIXA_TEMPO_SERVICO_INI,
                                      RLO_FAIXA_TEMPO_SERVICO_FIM, RLO_FAIXA_SALARIO_INI, RLO_FAIXA_SALARIO_FIM,
                                      RLO_FAIXA_MARGEM_FOLHA_INI, RLO_FAIXA_MARGEM_FOLHA_FIM, RLO_PADRAO_MATRICULA,
                                      RLO_PADRAO_CATEGORIA, RLO_PADRAO_VERBA, RLO_PADRAO_VERBA_REF, RLO_MENSAGEM_ERRO,
                                      RLO_LIMITE_QUANTIDADE, RLO_LIMITE_DATA_FIM_ADE, RLO_LIMITE_PRAZO,
                                      RLO_LIMITE_VALOR_PARCELA, RLO_LIMITE_VALOR_LIBERADO, RLO_LIMITE_CAPITAL_DEVIDO)
select RLO_CODIGO,
       EST_CODIGO,
       ORG_CODIGO,
       SBO_CODIGO,
