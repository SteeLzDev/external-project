...
@Log4j2
public class RelatorioConsignacoesTest extends BaseTest {
    ...
    public void beforeEach() throws Exception {
		...
		itemMenuFavoritoService.incluirItemMenuFavorito(usuCodigo,
				Integer.toString(ItemMenuEnum.RELATORIO_CONSIGNACOES.getCodigo()));
	}
	...
	/**
	 * Teste automatizado que gera o "Relatorio de Consignações" e/ou realiza seu
	 * agendamento.
	 */
	@Test
	public void relatorioConsignacoesSemAgendamento() {
		log.info("Relatorio Consignacoes sem agendamento");
		...
		menuPage.acessarFavoritosRelatorioConsignacoes();
	...
	@Test
	public void relatorioConsignacoesComAgendamento() {
		log.info("Relatorio Consignacoes com agendamento");

		relCodigo = relatorioDao.findByFunCodigo(CodedValues.FUN_REL_CONSIGNACOES).getRelCodigo();
		...
		assertTrue(webDriver.getPageSource().contains("Relatório de Consignações"));
