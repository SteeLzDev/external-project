...
@Log4j2
public class RelatorioLimiteContratoEntidadeTest extends BaseTest {
    ...
    public void beforeEach() throws Exception {
		...
		itemMenuFavoritoService.incluirItemMenuFavorito(usuCodigo,
				Integer.toString(ItemMenuEnum.RELATORIO_LIMITE_DE_CONTRATO_POR_ENTIDADE.getCodigo()));
	}
	...
	/**
	 * Teste automatizado que gera o "Relatorio de Limite de Contrato por Entidade"
	 * e/ou realiza seu agendamento.
	 */
	@Test
	public void relatorioLimiteContratoEntidadeSemAgendamento() {
		log.info("Relatorio Limite Contrato Entidade sem agendamento");
		...
		menuPage.acessarFavoritosRelatorioLimiteContratoEntidade();

		// preencher dados para gerar relatorio formato PDF
		relatoriosPage.preencherMatricula("123456");
	...
	@Test
	public void relatorioLimiteContratoEntidadeComAgendamento() {
		log.info("Relatorio Limite Contrato Entidade com agendamento");

		relCodigo = relatorioDao.findByFunCodigo(CodedValues.FUN_REL_LIMITE_CONTRATO_ENTIDADE).getRelCodigo();
		...
		assertTrue(
				webDriver.getPageSource().contains("Relatório de Limite de Contrato por Entidade"));
