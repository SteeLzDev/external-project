...
@Log4j2
public class RelatorioEstatisticoRetornoTest extends BaseTest {
	...
	/**
	 * Teste automatizado que faz o download do "Relatorio Estatistico Retorno", se
	 * existir arquivo disponivel.
	 */
	@Test
	public void relatorioEstatisticoRetornoSemAgendamento() {
		log.info("Relatorio Estatistico Retorno sem agendamento");
		...
		itemMenuFavoritoService.incluirItemMenuFavorito(usuCodigo,
				Integer.toString(ItemMenuEnum.RELATORIO_ESTATISTICO_RETORNO.getCodigo()));
		...
		menuPage.acessarFavoritosRelatorioEstatisticoRetorno();
