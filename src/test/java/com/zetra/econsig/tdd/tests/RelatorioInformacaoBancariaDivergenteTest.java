...
@Log4j2
public class RelatorioInformacaoBancariaDivergenteTest extends BaseTest {
    ...
    public void beforeEach() throws Exception {
		...
		itemMenuFavoritoService.incluirItemMenuFavorito(usuCodigo,
				Integer.toString(ItemMenuEnum.RELATORIO_INFORMACAO_BANCARIA_DIVERGENTE.getCodigo()));
	}
	...
	/**
	 * Teste automatizado que gera o "Relatorio de Contratos com Informacao Bancaria
	 * Divergente da Conta Salario" e/ou realiza seu agendamento.
	 */
	@Test
	public void relatorioInformacaoBancariaDivergenteSemAgendamento() {
		log.info("Relatorio Informacao Bancaria Divergente sem agendamento");
		...
		menuPage.acessarFavoritosRelatorioInformacaoBancariaDivergente();
		...
		SeleniumHelper.visibilityOfElementLocated(By.id("periodoIni"));
	...
	@Test
	public void relatorioInformacaoBancariaDivergenteComAgendamento() {
		log.info("Relatorio Informacao Bancaria Divergente com agendamento");

		relCodigo = relatorioDao.findByFunCodigo(CodedValues.FUN_REL_INF_BANC_DIVERGENTE).getRelCodigo();
