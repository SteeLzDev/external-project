...
@Log4j2
public class RelatorioComprometimentoMargemTest extends BaseTest {
    ...
    public void beforeEach() throws Exception {
		...
		itemMenuFavoritoService.incluirItemMenuFavorito(usuCodigo,
				Integer.toString(ItemMenuEnum.RELATORIO_COMPROMETIMENTO_DE_MARGEM.getCodigo()));
	}
	...
	/**
	 * Teste automatizado que gera o "Relatorio de Comprometimento de Margem" e/ou
	 * realiza seu agendamento.
	 */

	@Test
	public void relatorioComprometimentoMargemSemAgendamento() {
		log.info("Relatorio Comprometimento Margem sem agendamento");
		...
		menuPage.acessarFavoritosRelatorioComprometimentoMargem();
	...
	@Test
	public void relatorioComprometimentoMargemComAgendamento() {
		log.info("Relatorio Comprometimento Margem com agendamento");

		relCodigo = relatorioDao.findByFunCodigo(CodedValues.FUN_REL_COMPROMETIMENTO).getRelCodigo();
		...
		assertTrue(webDriver.getPageSource().contains("Relatório de Comprometimento de Margem"));
