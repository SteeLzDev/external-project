...
@Log4j2
public class RelatorioContratoLiquidadoPosCorteTest extends BaseTest {
    ...
    public void beforeEach() throws Exception {
		...
		itemMenuFavoritoService.incluirItemMenuFavorito(usuCodigo,
				Integer.toString(ItemMenuEnum.RELATORIO_CONTRATO_LIQUIDADO_POS_CORTE.getCodigo()));
	}
	...
	/**
	 * Teste automatizado que gera o "Relatorio de Contrato Liquidado Pos-Corte"
	 * e/ou realiza seu agendamento.
	 */
	@Test
	public void relatorioContratoLiquidadoPosCorteSemAgendamento() {
		log.info("Relatorio Contrato Liquidado Pos Corte sem agendamento");
		...
		menuPage.acessarFavoritosRelatorioContratoLiquidadoPosCorte();
	...
	@Test
	public void relatorioContratoLiquidadoPosCorteComAgendamento() {
		log.info("Relatorio Contrato Liquidado Pos Corte com agendamento");

		relCodigo = relatorioDao.findByFunCodigo(CodedValues.FUN_REL_CONTRATO_LIQUIDADO_POS_CORTE).getRelCodigo();
		...
		assertTrue(webDriver.getPageSource().contains("Relatório de Contrato Liquidado Pós-Corte"));
