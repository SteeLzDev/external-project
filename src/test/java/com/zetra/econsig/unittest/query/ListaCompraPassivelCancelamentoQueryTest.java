...
public class ListaCompraPassivelCancelamentoQueryTest extends AbstractQueryTest {

    @Test
    public void test_01() throws com.zetra.econsig.exception.ZetraException {

        ListaCompraPassivelCancelamentoQuery query = new ListaCompraPassivelCancelamentoQuery();
