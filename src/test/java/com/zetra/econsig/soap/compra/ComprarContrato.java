...
@XmlRootElement(name = "comprarContrato")
public class ComprarContrato {
    ...
    @XmlElementRef(name = "novoAdeIdentificador", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> novoAdeIdentificador;
    @XmlElementRef(name = "dataNascimento", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dataNascimento;
    protected String valorParcela;
    @XmlElementRef(name = "valorLiberado", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> valorLiberado;
    @XmlElementRef(name = "codVerba", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codVerba;
    @XmlElementRef(name = "servicoCodigo", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> servicoCodigo;
    protected int prazo;
    @XmlElementRef(name = "carencia", namespace = "CompraService", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "correspondenteCodigo", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> correspondenteCodigo;
    @XmlElementRef(name = "valorTac", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> valorTac;
    @XmlElementRef(name = "indice", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> indice;
    @XmlElementRef(name = "valorIof", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> valorIof;
    @XmlElementRef(name = "valorMensVin", namespace = "CompraService", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "orgaoCodigo", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> orgaoCodigo;
    @XmlElementRef(name = "estabelecimentoCodigo", namespace = "CompraService", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "taxaJuros", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> taxaJuros;
    @XmlElementRef(name = "naturezaServicoCodigo", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> naturezaServicoCodigo;
    @XmlElementRef(name = "anexo", namespace = "CompraService", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<String> getValorTac() {
        return valorTac;
    }
     ...
     *     
     */
    public void setValorTac(JAXBElement<String> value) {
        this.valorTac = value;
    }
