...
@XmlRootElement(name = "retirarContratoDaCompra")
public class RetirarContratoDaCompra {
    ...
    @XmlElementRef(name = "codigoMotivoOperacao", namespace = "CompraService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codigoMotivoOperacao;
    @XmlElementRef(name = "obsMotivoOperacao", namespace = "CompraService", type = JAXBElement.class, required = false)
