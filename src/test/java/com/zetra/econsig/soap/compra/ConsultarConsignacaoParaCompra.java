...
@XmlRootElement(name = "consultarConsignacaoParaCompra")
public class ConsultarConsignacaoParaCompra {
    ...
    @XmlElementRef(name = "adeIdentificador", namespace = "CompraService", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "senhaServidor", namespace = "CompraService", type = JAXBElement.class, required = false)
