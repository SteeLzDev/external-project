...
@XmlRootElement(name = "renegociarConsignacao")
public class RenegociarConsignacao {
    ...
    protected Long adeNumeros;
    @XmlElement(nillable = true)
    protected List<String> adeIdentificador;
     ...
     * This is why there is not a <CODE>set</CODE> method for the adeNumeros property.
     * 
     * <p>
     ...
     * 
     */
    public Long getAdeNumeros() {
        return this.adeNumeros;
    }

    public void setAdeNumeros(Long adeNumeros) {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the adeIdentificador property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<String> getAdeIdentificador() {
        if (adeIdentificador == null) {
            adeIdentificador = new ArrayList<String>();
        }
