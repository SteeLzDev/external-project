...
/**
 * <p>Title: RegraAlteracaoExclusaoCodReg5</p>
 * <p>Description: Classe com a implementação MYSQL da regra com a verificação de alteração/
 *    exlcusão com registros tipo '5' (Marinha).</p>
 ...
 * $Date$
 */
public class RegraAlteracaoExclusaoCodReg5 extends Regra {
    /** Log object for this class. */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(RegraAlteracaoExclusaoCodReg5.class);
    ...
    private List<TransferObject> buscaQtdLinhasInvalidas() {
        ...
        try {
            ...
            query.append("WHERE ade_cod_reg = '5' AND amv_operacao IN ('A', 'E') ");
