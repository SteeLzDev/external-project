...
/**
 * <p>Title: RegraQtdRegistrosExclusao</p>
 * <p>Description: Classe abstrata com a implementação MYSQL da regra com a da quantidade de registros de exclusão gerados.</p>
 ...
 * $Date$
 */
public class RegraQtdRegistrosExclusao extends AbstractRegraQtdRegistros {
    public RegraQtdRegistrosExclusao() {
        super("E");
    }
