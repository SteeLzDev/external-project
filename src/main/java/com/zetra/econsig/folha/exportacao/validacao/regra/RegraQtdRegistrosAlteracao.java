...
/**
 * <p>Title: RegraQtdRegistrosAlteracao</p>
 * <p>Description: Classe abstrata com a implementação MYSQL da regra com a da quantidade de registros de alteração gerados.</p>
 ...
 * $Date$
 */
public class RegraQtdRegistrosAlteracao extends AbstractRegraQtdRegistros {
    public RegraQtdRegistrosAlteracao() {
        super("A");
    }
