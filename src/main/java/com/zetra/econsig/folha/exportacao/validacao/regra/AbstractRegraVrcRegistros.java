...
/**
 * <p>Title: AbstractRegraVrcRegistros</p>
 * <p>Description: Classe abstrata com a implementação MYSQL da regra com a comparação da quantidade de registros gerados.</p>
 ...
 * $Date$
 */
public abstract class AbstractRegraVrcRegistros extends Regra {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(AbstractRegraVrcRegistros.class);

    protected String operacao;

    public AbstractRegraVrcRegistros(String operacao) {
    ...
    private List<TransferObject> buscaVariacaoPorCsa() {
        ...
        try {
            ...
            query.append("sum(coalesce((select sum(hmf_qtd) from tb_historico_mov_fin hmf where hmf.cnv_codigo = cnv.cnv_codigo and hmf_operacao = '").append(operacao).append("' and hmf_periodo = date_sub('").append(periodo).append("', interval 1 month)), 0)) as QTD_ANTERIOR, ");
