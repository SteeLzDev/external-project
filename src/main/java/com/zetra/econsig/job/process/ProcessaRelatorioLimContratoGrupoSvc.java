...
/**
 * <p>Title: ProcessaRelatorioLimContratoGrupoSvc</p>
 * <p>Description: Classe para processamento de relatorio de limite de contrato por grupo de servico
 * de lote</p>
 ...
 * $Date$
 */
public final class ProcessaRelatorioLimContratoGrupoSvc extends ProcessaRelatorio {
    /** Log object for this class. */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(ProcessaRelatorioLimContratoGrupoSvc.class);

    public ProcessaRelatorioLimContratoGrupoSvc(Relatorio relatorio, Map<String, String[]> parameterMap, HttpSession session, Boolean agendado, AcessoSistema responsavel) {
    ...
    protected void executar() {
        ...
        String grupoServico = parameterMap.get("grupoServico")[0];
        String nomeGrupoServico = grupoServico.split(";")[1];

        grupoServico = grupoServico.split(";")[0];

        String titulo = relatorio.getTitulo();
        StringBuilder subtitulo = new StringBuilder();

        String nome = getNomeArquivo(ApplicationResourcesHelper.getMessage("rotulo.nome.arquivo.relatorio.limite.contrato.grupo.svc", responsavel), responsavel, parameterMap, null);

        if (nomeGrupoServico != null && !nomeGrupoServico.equals("")) {
            subtitulo.append(System.getProperty("line.separator"));
            subtitulo.append(ApplicationResourcesHelper.getMessage("rotulo.grupo.servico.arg0", responsavel, nomeGrupoServico));
        }
        ...
        criterio.setAttribute("TGS_CODIGO", grupoServico);
