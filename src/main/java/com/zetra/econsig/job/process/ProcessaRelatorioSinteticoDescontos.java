...
/**
 * <p>Title: ProcessaRelatorioSinteticoDescontos</p>
 * <p>Description: Classe para processamento de relatorio sintetico de Descontos de Permissionários</p>
 ...
 * $Date:$
 */
public final class ProcessaRelatorioSinteticoDescontos extends ProcessaRelatorio {
    /** Log object for this class. */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(ProcessaRelatorioSinteticoDescontos.class);

    public ProcessaRelatorioSinteticoDescontos(Relatorio relatorio, Map<String, String[]> parameterMap, HttpSession session, Boolean agendado, AcessoSistema responsavel) {
    ...
    protected void executar() {
        ...
        StringBuilder nome = new StringBuilder(getNomeArquivo(ApplicationResourcesHelper.getMessage("rotulo.nome.arquivo.relatorio.sintetico.descontos", responsavel), responsavel, parameterMap, null));
        ...
        try {
            ...
            Pair<String[], List<TransferObject>> conteudo = relatorioController.geraRelatorioSinteticoDescontos(criterio, responsavel);
    ...
    public Map<String, List<SinteticoDataSourceBean>> preparaGrafico(List<TransferObject> conteudo, String[] fields ){
        ...
        parametros.put("CSA", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("CORRESPONDENTE", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("SERVICO", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("SITUACAO", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("PERIODO", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("ORGAO", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("ESTABELECIMENTO", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("CSA_PERIODO", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("DATA_INICIO", new ArrayList<SinteticoDataSourceBean>());
        parametros.put("DATA_FIM", new ArrayList<SinteticoDataSourceBean>());
        ...
        if(campos.contains(Columns.CSA_NOME)){
            ...
            for(String key: csaMap.keySet()){
                SinteticoDataSourceBean elemento = new SinteticoDataSourceBean(key, csaMap.get(key));
        ...
        if(campos.contains(Columns.COR_NOME)){
            ...
            for(String key: corMap.keySet()){
                SinteticoDataSourceBean elemento = new SinteticoDataSourceBean(key, corMap.get(key));
        ...
        if(campos.contains(Columns.SVC_DESCRICAO)){
            ...
            for(String key: serMap.keySet()){
                SinteticoDataSourceBean elemento = new SinteticoDataSourceBean(key, serMap.get(key));
        ...
        if(campos.contains(Columns.SAD_DESCRICAO)){
            ...
            for(String key: sitMap.keySet()){
                SinteticoDataSourceBean elemento = new SinteticoDataSourceBean(key, sitMap.get(key));
        ...
        if(campos.contains(Columns.ORG_NOME)){
            ...
            for(String key: orgMap.keySet()){
                SinteticoDataSourceBean elemento = new SinteticoDataSourceBean(key, orgMap.get(key));
        ...
        if(campos.contains(Columns.EST_NOME)){
            ...
            for(String key: estMap.keySet()){
                SinteticoDataSourceBean elemento = new SinteticoDataSourceBean(key, estMap.get(key));
        ...
        if(campos.contains(Columns.ADE_ANO_MES_INI)){
            ...
            for(String key: dataIniMap.keySet()){
                SinteticoDataSourceBean elemento = new SinteticoDataSourceBean(key, dataIniMap.get(key));
        ...
        if(campos.contains(Columns.ADE_ANO_MES_FIM)){
            ...
            for(String key: dataFimMap.keySet()){
                SinteticoDataSourceBean elemento = new SinteticoDataSourceBean(key, dataFimMap.get(key));
