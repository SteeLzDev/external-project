...
import com.zetra.econsig.report.jasper.dinamico.RelatorioInclusoesPorCsaInfo;
 ...
 * <p>Description: Classe que dispara processo para montar relatório sintético de mov. financeira</p>
 ...
 * $Date$
 */
public class ProcessaRelatorioInclusoesPorCsa extends ProcessaRelatorio {
    /** Log object for this class. */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(ProcessaRelatorioInclusoesPorCsa.class);

    public ProcessaRelatorioInclusoesPorCsa(Relatorio relatorio, Map<String, String[]> parameterMap, HttpSession session, Boolean agendado, AcessoSistema responsavel) {
    ...
    protected void executar() {
        ...
        StringBuilder nomeArquivo = new StringBuilder(getNomeArquivo(ApplicationResourcesHelper.getMessage("rotulo.nome.arquivo.relatorio.inclusoes.por.csa", responsavel), responsavel, parameterMap, null));
        ...
        try {
            ...
            List<Object> conteudo = relatorioController.geraRelatorioInclusoesPorCsa(criterio, responsavel);
            List<Object[]> conteudoList = DTOToList((List<TransferObject>)conteudo.get(0),(String[])conteudo.get(1));

            RelatorioInclusoesPorCsaInfo relInfo =  new RelatorioInclusoesPorCsaInfo(relatorio);
