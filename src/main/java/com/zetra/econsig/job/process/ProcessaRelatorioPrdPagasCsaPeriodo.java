...
import com.zetra.econsig.report.jasper.dinamico.RelatorioPrdPagasPorCsaPeriodoInfo;
...
/**
 * <p> Title: ProcessaRelatorioPrdPagasCsaPeriodo</p>
 * <p> Description: Processa o Relatório Sintético de Parcelas Pagas por Consignatária e período</p>
 ...
 * $Date$
 */
public class ProcessaRelatorioPrdPagasCsaPeriodo extends ProcessaRelatorio {
    /** Log object for this class. */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(ProcessaRelatorioPrdPagasCsaPeriodo.class);

    public ProcessaRelatorioPrdPagasCsaPeriodo(Relatorio relatorio, Map<String, String[]> parameterMap, HttpSession session, Boolean agendado, AcessoSistema responsavel) {
    ...
    protected void executar() {
        ...
        StringBuilder nome = new StringBuilder(getNomeArquivo(ApplicationResourcesHelper.getMessage("rotulo.nome.arquivo.relatorio.prd.por.csa", responsavel), responsavel, parameterMap, null));
        ...
        try {
            ...
            List<Object> conteudo = relatorioController.geraRelatorioPrdPagasCsaPeriodo(criterio, responsavel);
            List<Object[]> conteudoList = DTOToList((List<TransferObject>)conteudo.get(0),(String[])conteudo.get(1));

            RelatorioPrdPagasPorCsaPeriodoInfo relInfo =  new RelatorioPrdPagasPorCsaPeriodoInfo(relatorio);
            CustomTransferObject criterioInfo = new CustomTransferObject();
            criterioInfo.setAttribute("countMes", conteudo.get(2));
            criterioInfo.setAttribute("campos", conteudo.get(3));
