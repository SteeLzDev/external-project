...
/**
 * <p> Title: ProcessaRelatorioAumentoADEValorForaLimite</p>
 ...
 * $Date$
 */
public final class ProcessaRelatorioAumentoADEValorForaLimite extends ProcessaRelatorio {
    /** Log object for this class. */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(ProcessaRelatorioAumentoADEValorForaLimite.class);

    public ProcessaRelatorioAumentoADEValorForaLimite(Relatorio relatorio, Map<String, String[]> parameterMap, HttpSession session, Boolean agendado, AcessoSistema responsavel) {
    ...
    protected void executar() {
        if (!parameterMap.containsKey("periodoIni") || !parameterMap.containsKey("periodoFim")) {
            ...
            String periodoIni = reformat(strIniPeriodo, LocaleHelper.getDatePattern(), "yyyy-MM-dd");
            ...
            String nome = getNomeArquivo(ApplicationResourcesHelper.getMessage("rotulo.nome.arquivo.relatorio.aumento.ade.valor.fora.limite", responsavel), responsavel, parameterMap, null);
