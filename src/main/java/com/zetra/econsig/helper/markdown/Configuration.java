...
public class Configuration
{
    ...
    final DecoratorExtended decorator;
     ...
     * @param decorator
     */
    Configuration(boolean safeMode, String encoding, DecoratorExtended decorator, BlockEmitter codeBlockEmitter,
    ...
    public static class Builder
    {
        ...
        private DecoratorExtended decorator = new DefaultDecoratorExtended();
         ...
         * @since 0.7
         */
        public Builder setDecorator(DecoratorExtended decorator)
        {
            this.decorator = decorator;
            return this;
        }
		...
		public DecoratorExtended getDecorator() {
			return decorator;
		}
    }
}
