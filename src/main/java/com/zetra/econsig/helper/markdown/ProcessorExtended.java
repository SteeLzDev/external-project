 ...
 */
public class ProcessorExtended
{
    /** The reader. */
    private final Reader reader;
    /** The emitter. */
    private final EmitterExtended emitter;
    /** The Configuration. */
     ...
     *            The input reader.
     */
    protected ProcessorExtended(final Reader reader, final Configuration config)
    {
        this.reader = reader;
        this.config = config;
        this.useExtensions = config.forceExtendedProfile;
        this.emitter = new EmitterExtended(this.config);
    }
    ...
    {
        final ProcessorExtended p = new ProcessorExtended(!(reader instanceof BufferedReader) ? new BufferedReader(reader) : reader,
                configuration);
        return p.process();
    }
    ...
    {
        final ProcessorExtended p = new ProcessorExtended(new BufferedReader(new InputStreamReader(input, configuration.encoding)),
                configuration);
        return p.process();
    }
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final String input, final DecoratorExtended decorator)
    {
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final String input, final DecoratorExtended decorator, final boolean safeMode)
    {
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final File file, final DecoratorExtended decorator) throws IOException
    {
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final File file, final DecoratorExtended decorator, final boolean safeMode)
            throws IOException
    {
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final File file, final String encoding, final DecoratorExtended decorator)
            throws IOException
    {
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final InputStream input, final DecoratorExtended decorator) throws IOException
    {
        return process(input, Configuration.builder().setDecorator(decorator).build());
    }
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final InputStream input, final DecoratorExtended decorator, final boolean safeMode)
            throws IOException
    {
        return process(input, Configuration.builder().setDecorator(decorator).setSafeMode(safeMode).build());
    }
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final InputStream input, final String encoding, final DecoratorExtended decorator)
            throws IOException
    {
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final Reader reader, final DecoratorExtended decorator) throws IOException
    {
     ...
     * @see Configuration#DEFAULT
     */
    public final static String process(final Reader reader, final DecoratorExtended decorator, final boolean safeMode)
            throws IOException
    {
