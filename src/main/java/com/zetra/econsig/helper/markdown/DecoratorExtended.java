 ...
 */
public interface DecoratorExtended
{
    /**
    ...
    /**
     * Called when a underline item is opened.
     *
     * <p>
     * <strong>Note:</strong> Don't close the HTML tag!
     * </p>
     ...
     *
     * <pre>
     * <code>out.append("&lt;u>");</code>
     * </pre>
     *
     * @param out
     *            The StringBuilder to write to.
     */
    public void openUnderline(final StringBuilder out);

    /**
     * Called when a underline item is closed.
     *
     * <p>
     * Default implementation is:
     * </p>
     ...
     *            The StringBuilder to write to.
     */
    public void closeUnderline(final StringBuilder out);
     ...
     *
     * <pre>
     * <code>out.append("&lt;font color="#ff0000">");</code>
     * </pre>
     *
     * @param out
     *            The StringBuilder to write to.
     */
    public void openColorRed(final StringBuilder out);
     ...
     *
     * <pre>
     * <code>out.append("&lt;/font>");</code>
     * </pre>
     *
     * @param out
     *            The StringBuilder to write to.
     */
    public void closeColorRed(final StringBuilder out);
    ...
    *
    * <pre>
    * <code>out.append("&lt;font color="#cccc00">");</code>
    * </pre>
    *
    * @param out
    *            The StringBuilder to write to.
    */
   public void openColorYellow(final StringBuilder out);
    ...
    *            The StringBuilder to write to.
    */
   public void closeColorYellow(final StringBuilder out);
   ...
   *
   * <pre>
   * <code>out.append("&lt;div align="left">");</code>
   * </pre>
   *
   * @param out
   *            The StringBuilder to write to.
   */
  public void openAlignLeft(final StringBuilder out);
   ...
   *
   * <pre>
   * <code>out.append("&lt;/div>");</code>
   * </pre>
   *
   * @param out
   *            The StringBuilder to write to.
   */
  public void closeAlignLeft(final StringBuilder out);
   ...
   *
   * <pre>
   * <code>out.append("&lt;div align="center">");</code>
   * </pre>
   *
   * @param out
   *            The StringBuilder to write to.
   */
  public void openAlignCenter(final StringBuilder out);
   ...
   *            The StringBuilder to write to.
   */
  public void closeAlignCenter(final StringBuilder out);
   ...
   *
   * <pre>
   * <code>out.append("&lt;div align="right">");</code>
   * </pre>
   *
   * @param out
   *            The StringBuilder to write to.
   */
  public void openAlignRight(final StringBuilder out);
   ...
   *            The StringBuilder to write to.
   */
  public void closeAlignRight(final StringBuilder out);

  public void openColorGreen(final StringBuilder out);

  public void closeColorGreen(final StringBuilder out);

  public void openColorBlue(final StringBuilder out);

  public void closeColorBlue(final StringBuilder out);

  public void openEstiloTitulo(final StringBuilder out);

  public void closeEstiloTitulo(final StringBuilder out);

  public void openEstiloSubtitulo(final StringBuilder out);

  public void closeEstiloSubtitulo(final StringBuilder out);

  public void openEstiloTexto(final StringBuilder out);

  public void closeEstiloTexto(final StringBuilder out);
