...
public class ExtDecoratorExtended extends DefaultDecoratorExtended {

    private final HtmlAttributes attributes = new HtmlAttributes();

    private final boolean includeParagraph;

    public ExtDecoratorExtended(boolean includeParagraph) {
        this.includeParagraph = includeParagraph;
    }

    public ExtDecoratorExtended addHtmlAttribute(String name, String value, String... tags) {
        for (String tag : tags) {
    ...
    public ExtDecoratorExtended addStyleClass(String styleClass, String... tags) {
        for (String tag : tags) {
    ...
    public ExtDecoratorExtended useCompactStyle() {
    ...
    public void openParagraph(StringBuilder out) {
        // DESENV-15476 - Com a implementação do texto sistema com markDown é necessário tirar esses parágrafos que são colocados em todos
        // os textos.
        if (includeParagraph && !open(out, "p")) {
