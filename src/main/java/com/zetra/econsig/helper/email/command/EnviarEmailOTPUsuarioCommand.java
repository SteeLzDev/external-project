...
/**
 * <p>Title: EnviarEmailUsuarioContratosRejeitadosCommand</p>
 ...
 * $Date$
 */
public class EnviarEmailOTPUsuarioCommand extends AbstractEnviarEmailCommand {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailOTPUsuarioCommand.class);
    ...
    public void execute() throws ViewHelperException {
		try {
			...
			ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(
					ModeloEmailEnum.ENVIAR_EMAIL_OTP_USUARIO, responsavel);
			...
			mailHelper.send(TipoNotificacaoEnum.EMAIL_OTP_USUARIO, email, null, null, titulo,
			        corpo, null, null, responsavel);

		} catch (Exception ex) {
		    LOG.error(ex.getMessage(), ex);
			throw new ViewHelperException("rotulo.email.otp.usuario.erro", responsavel, ex);
		}
