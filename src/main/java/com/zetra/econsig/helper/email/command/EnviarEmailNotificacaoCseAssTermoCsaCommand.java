...
/**
 * <p>Title: EnviarEmailNotificacaoCseAssTermoCsaCommand</p>
 * <p>Description: Command para envio de email informando que o termo aditivo foi assinado pela csa
 * de consignante.</p>
 ...
 */
public class EnviarEmailNotificacaoCseAssTermoCsaCommand extends AbstractEnviarEmailCommand {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailNotificacaoCseAssTermoCsaCommand.class);
    ...
    public void execute() throws ViewHelperException {
		try {
			...
			ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(ModeloEmailEnum.ENVIAR_EMAIL_NOTIFICACAO_TERMO_ASS_CREDENCIAMENTO_CSA, responsavel);
