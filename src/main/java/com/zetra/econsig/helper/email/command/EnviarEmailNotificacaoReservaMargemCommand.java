...
public class EnviarEmailNotificacaoReservaMargemCommand extends AbstractEnviarEmailCommand {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailNotificacaoReservaMargemCommand.class);
    ...
    public void execute() throws ViewHelperException {
        try {
            ...
            final ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(ModeloEmailEnum.ENVIAR_EMAIL_NOTIFICACAO_RESERVA_MARGEM, responsavel);
            ...
            mailHelper.send(TipoNotificacaoEnum.EMAIL_NOTIFICACAO_RESERVA_MARGEM, email, null, null, titulo, corpo, null, null, responsavel);
