...
/**
 * <p>Title: EnviarEmailNotificacaoSituacaoCsaCredenciamentoCommand</p>
 * <p>Description: Command para envio de email atualização do credenciamento para a consignatária
 * de consignante.</p>
 ...
 */
public class EnviarEmailNotificacaoSituacaoCsaCredenciamentoCommand extends AbstractEnviarEmailCommand {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailNotificacaoSituacaoCsaCredenciamentoCommand.class);
    ...
    public void execute() throws ViewHelperException {
		try {
			...
			ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(ModeloEmailEnum.ENVIAR_EMAIL_NOTIFICACAO_SITUACAO_CREDENCIAMENTO_CSA, responsavel);
