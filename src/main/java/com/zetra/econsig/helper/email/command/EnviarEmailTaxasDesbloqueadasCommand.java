...
/**
 * <p>Title: EnviarEmailTaxasDesbloqueadasCommand</p>
 * <p>Description: Command para envio de email diário para consignatárias com prazo de validade para taxas desbloqueadas.</p>
 ...
 * $Date$
 */
public class EnviarEmailTaxasDesbloqueadasCommand extends AbstractEnviarEmailCommand {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailTaxasDesbloqueadasCommand.class);
    ...
    public void execute() throws ViewHelperException {
        try {
            ...
            ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(ModeloEmailEnum.ENVIAR_EMAIL_DIARIO_TAXAS_DESBLOQUEADAS, responsavel);
            ...
            mailHelper.send(TipoNotificacaoEnum.EMAIL_DIARIO_ALERTA_CET_DESBLOQUEADAS, csaEmail, null, null, titulo, corpo, null, null, responsavel);
