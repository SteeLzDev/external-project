...
/**
 * <p>Title: EnviarEmailTaxasExpiradasEm7DiasCommand</p>
 * <p>Description: Command para envio de email diário para consignatárias com prazo de validade para taxas expirando em 7 dias.</p>
 ...
 * $Date$
 */
public class EnviarEmailTaxasExpiradasEm7DiasCommand extends AbstractEnviarEmailCommand {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailTaxasExpiradasEm7DiasCommand.class);
    ...
    public void execute() throws ViewHelperException {
        try {
            ...
            ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(ModeloEmailEnum.ENVIAR_EMAIL_DIARIO_EXPIRACAO_TAXAS_7_DIAS, responsavel);
            ...
            mailHelper.send(TipoNotificacaoEnum.EMAIL_DIARIO_ALERTA_EXPIRACAO_CET_EM_7_DIAS, csaEmail, null, null, titulo, corpo, null, null, responsavel);
