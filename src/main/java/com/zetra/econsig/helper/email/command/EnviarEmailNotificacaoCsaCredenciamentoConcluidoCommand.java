 ...
 */
public class EnviarEmailNotificacaoCsaCredenciamentoConcluidoCommand extends AbstractEnviarEmailCommand {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailNotificacaoCsaCredenciamentoConcluidoCommand.class);
    ...
    public void execute() throws ViewHelperException {
		try {
			...
			ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(ModeloEmailEnum.ENVIAR_EMAIL_NOTIFICACAO_CREDENCIAMENTO_CONCLUIDO_CSA, responsavel);
