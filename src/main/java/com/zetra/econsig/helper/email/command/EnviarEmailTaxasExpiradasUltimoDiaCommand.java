...
/**
 * <p>Title: EnviarEmailTaxasExpiradasUltimoDiaCommand</p>
 * <p>Description: Command para envio de email diário para consignatárias com prazo de validade para taxas expirando hoje.</p>
 ...
 * $Date$
 */
public class EnviarEmailTaxasExpiradasUltimoDiaCommand extends AbstractEnviarEmailCommand {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailTaxasExpiradasUltimoDiaCommand.class);
    ...
    public void execute() throws ViewHelperException {
        try {
            ...
            ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(ModeloEmailEnum.ENVIAR_EMAIL_DIARIO_EXPIRACAO_TAXAS_HOJE, responsavel);
            ...
            mailHelper.send(TipoNotificacaoEnum.EMAIL_DIARIO_ALERTA_EXPIRACAO_CET_HOJE, csaEmail, null, null, titulo, corpo, null, null, responsavel);
