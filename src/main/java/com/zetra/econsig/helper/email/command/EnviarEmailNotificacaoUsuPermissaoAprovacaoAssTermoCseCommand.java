...
/**
 * <p>Title: EnviarEmailNotificacaoUsuPermissaoAprovacaoAssTermoCseCommand</p>
 * <p>Description: Command para envio de email informando que o termo aditivo foi assinado pela cse para os usuário
 * com função de permissão para aprovação
 * de consignante.</p>
 ...
 */
public class EnviarEmailNotificacaoUsuPermissaoAprovacaoAssTermoCseCommand extends AbstractEnviarEmailCommand {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(EnviarEmailNotificacaoUsuPermissaoAprovacaoAssTermoCseCommand.class);
    ...
    public void execute() throws ViewHelperException {
		try {
			...
			ModeloEmailInterpolator interpolador = getModeloEmailInterpolator(ModeloEmailEnum.ENVIAR_EMAIL_NOTIFICACAO_TERMO_ASS_CREDENCIAMENTO_CSE, responsavel);
            ...
            if (ParamSist.paramEquals(CodedValues.TPC_INSERE_ANEXO_CREDENCIAMENTO_CONSIGNATARIA, CodedValues.TPC_SIM, responsavel)) {
                mailHelper.send(TipoNotificacaoEnum.EMAIL_CONSIGNATARIA_CREDENCIAMENTO, email, null, null, titulo, corpo, anexos, null, responsavel);
            } else {
