 ...
 * <p>Title: JspHelper</p>
 * <p>Description: Helper Class para operações Google Authenticator.</p>
...
public class GoogleAuthenticatorHelper {
    ...
    public static final String CHAVE_VALIDACAO = "CHAVE_VALIDACAO";
     ...
     */
    public static String generateSecretKey() throws NoSuchAlgorithmException, NoSuchProviderException {
        ...
        (SecureRandom.getInstance("SHA1PRNG","SUN")).nextBytes(buffer);
