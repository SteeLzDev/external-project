...
/**
 * <p>Title: CancelarCompraCommand</p>
 * <p>Description: classe command que trata requisição externa ao eConsig de cancelar compra de contrato</p>
 ...
 * $Date$
 */
public class CancelarCompraCommand extends RequisicaoExternaCommand {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(CancelarCompraCommand.class);

    public CancelarCompraCommand(Map<CamposAPI, Object> parametros, AcessoSistema responsavel) {
    ...
    protected void executaOperacao(Map<CamposAPI, Object> parametros) throws ZetraException {
        ...
        // as ade a serem canceladas são as de destino do relacionamento
        List<TransferObject> relacionamentos = adeDelegate.pesquisarConsignacaoRelacionamento(null, adeCodigo, null, responsavel.getCsaCodigo(), CodedValues.TNT_CONTROLE_COMPRA, listStc, responsavel);
        ...
        consigDelegate.cancelarConsignacao(adeCodigo, tmoTO, responsavel);
    }
}
