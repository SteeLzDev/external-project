...
/**
 * <p>Title: RejeitarPgSaldoDevedorCommand</p>
 * <p>Description: classe command que trata requisição externa ao eConsig de rejeitar compra de contrato</p>
 ...
 * $Date$
 */
public class RejeitarPgSaldoDevedorCommand extends RequisicaoExternaCommand {

    public RejeitarPgSaldoDevedorCommand(Map<CamposAPI, Object> parametros, AcessoSistema responsavel) {
    ...
    protected void executaOperacao(Map<CamposAPI, Object> parametros) throws ZetraException {
        ...
        listStc.add(CodedValues.STC_AGUARD_LIQUIDACAO.toString());
        List<TransferObject> relacionamentos = adeDelegate.pesquisarConsignacaoRelacionamento(adeCodigo, null, responsavel.getCsaCodigo(), null, CodedValues.TNT_CONTROLE_COMPRA, listStc, responsavel);
        ...
        sdvDelegate.rejeitarPagamentoSaldoDevedor(adeCodigo, obs, responsavel);
