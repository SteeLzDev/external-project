...
/**
 * <p>Title: RespostaLiquidarParcelaCommand</p>
 * <p>Description: classe command que gera parcela em resposta à requisição externa de liquidar parcela.</p>
 ...
 * $Date$
 */
public class RespostaLiquidarParcelaCommand extends RespostaRequisicaoExternaCommand {

    public RespostaLiquidarParcelaCommand(AcessoSistema responsavel) {
        super(responsavel);
    }
