...
/**
 * <p>Title: CancelarReservaCommand</p>
 * <p>Description: classe command que trata requisição externa ao eConsig de cancelar reserva</p>
 ...
 * $Date$
 */
public class CancelarReservaCommand extends RequisicaoExternaCommand {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(CancelarReservaCommand.class);

    public CancelarReservaCommand(Map<CamposAPI, Object> parametros, AcessoSistema responsavel) {
