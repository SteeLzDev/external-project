...
/**
 * <p>Title: SuspenderConsignacaoCommand</p>
 * <p>Description: classe command que trata requisição externa ao eConsig de suspender consignação</p>
 ...
 * $Date$
 */
public class SuspenderConsignacaoCommand extends RequisicaoExternaCommand {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(SuspenderConsignacaoCommand.class);

    public SuspenderConsignacaoCommand(Map<CamposAPI, Object> parametros, AcessoSistema responsavel) {
    ...
    protected void executaOperacao(Map<CamposAPI, Object> parametros) throws ZetraException {
        ...
        if (autorizacao != null) {
            ...
            consigDelegate.suspenderConsignacao(adeCodigo, tmoTO, responsavel);
        }
    }
}
