...
/**
 * <p>Title: CancelarSolicitacaoCommand</p>
 * <p>Description: classe command que trata requisição externa ao eConsig de cancelar solicitação</p>
 ...
 * $Date$
 */
public class CancelarSolicitacaoCommand extends RequisicaoExternaCommand {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(CancelarSolicitacaoCommand.class);

    public CancelarSolicitacaoCommand(Map<CamposAPI, Object> parametros, AcessoSistema responsavel) {
    ...
    protected void executaOperacao(Map<CamposAPI, Object> parametros) throws ZetraException {
        ...
        if (autorizacao != null) {
            ...
            if (responsavel.isSer()) {
                consigDelegate.criaOcorrenciaADE(adeCodigo, CodedValues.TOC_OPERACAO_HOST_A_HOST, ApplicationResourcesHelper.getMessage("mensagem.informacao.cancelamento.solicitacao.host.a.host", responsavel), responsavel);
            }
        }
    }
}
