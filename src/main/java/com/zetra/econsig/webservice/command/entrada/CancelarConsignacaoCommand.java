...
/**
 * <p>Title: CancelarConsignacaoCommand</p>
 * <p>Description: classe command que trata requisição externa ao eConsig de cancelar consignação</p>
 ...
 * $Date$
 */
public class CancelarConsignacaoCommand extends RequisicaoExternaCommand {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(CancelarConsignacaoCommand.class);

    public CancelarConsignacaoCommand(Map<CamposAPI, Object> parametros, AcessoSistema responsavel) {
    ...
    protected void executaOperacao(Map<CamposAPI, Object> parametros) throws ZetraException {
        ...
        if (autorizacao != null) {
            ...
            consigDelegate.cancelarConsignacao(adeCodigo, false, tmoTO, responsavel);
            ...
            CustomTransferObject autdes = adeDelegate.buscaAutorizacao(adeCodigo, responsavel);
