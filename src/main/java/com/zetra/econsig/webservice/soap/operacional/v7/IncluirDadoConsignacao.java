...
@XmlRootElement(name = "incluirDadoConsignacao", namespace = "HostaHostService-v7_0")
public class IncluirDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoValor", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
