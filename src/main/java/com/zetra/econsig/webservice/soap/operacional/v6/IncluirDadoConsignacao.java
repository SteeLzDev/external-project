...
@XmlRootElement(name = "incluirDadoConsignacao", namespace = "HostaHostService-v6_0")
public class IncluirDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoValor", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
