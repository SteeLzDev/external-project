...
@XmlRootElement(name = "listarDadoConsignacao", namespace = "HostaHostService-v7_0")
public class ListarDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoCodigo", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
