...
@XmlRootElement(name = "incluirDadoConsignacao", namespace = "HostaHostService-v4_0")
public class IncluirDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoValor", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
