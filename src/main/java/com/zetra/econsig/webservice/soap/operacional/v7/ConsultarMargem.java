...
@XmlRootElement(name = "consultarMargem", namespace = "HostaHostService-v7_0")
public class ConsultarMargem {
    ...
    @XmlElementRef(name = "matriculaMultipla", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
