...
@XmlRootElement(name = "detalharConsultaConsignacaoResponse", namespace = "HostaHostService-v6_0")
public class DetalharConsultaConsignacaoResponse {
    ...
    @XmlElementRef(name = "boleto", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
