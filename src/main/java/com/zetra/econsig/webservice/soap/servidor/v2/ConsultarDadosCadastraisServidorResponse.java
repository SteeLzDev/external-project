...
@XmlRootElement(name = "consultarDadosCadastraisServidorResponse", namespace = "ServidorService-v2_0")
public class ConsultarDadosCadastraisServidorResponse {
    ...
    @XmlElementRef(name = "dadosServidor", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
