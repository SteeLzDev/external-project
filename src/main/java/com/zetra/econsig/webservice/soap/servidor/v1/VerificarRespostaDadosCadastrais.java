 ...
 *         <element name="grupoPergunta" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         <element name="pergunta" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "verificarRespostaDadosCadastrais", namespace = "ServidorService-v1_0")
public class VerificarRespostaDadosCadastrais {
    ...
    @XmlElement(namespace = "ServidorService-v1_0", required = true)
    protected String grupoPergunta;
    @XmlElement(namespace = "ServidorService-v1_0", required = true)
    protected String pergunta;
    @XmlElement(namespace = "ServidorService-v1_0", required = true)
    protected String resposta;
    @XmlElementRef(name = "usuario", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    ...
    /**
     * Obtém o valor da propriedade grupoPergunta.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getGrupoPergunta() {
        return grupoPergunta;
    }

    /**
     * Define o valor da propriedade grupoPergunta.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setGrupoPergunta(String value) {
        this.grupoPergunta = value;
    }
