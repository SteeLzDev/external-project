...
@XmlRootElement(name = "listarDadoConsignacao", namespace = "HostaHostService-v8_0")
public class ListarDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoCodigo", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
