...
@XmlRootElement(name = "comprarContrato", namespace = "CompraService-v1_0")
public class ComprarContrato {
    ...
    @XmlElement(namespace = "CompraService-v1_0", nillable = true)
    protected List<java.lang.Long> adeNumeros;
    @XmlElement(namespace = "CompraService-v1_0", nillable = true)
    protected List<java.lang.String> adeIdentificador;
    @XmlElementRef(name = "novoAdeIdentificador", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> novoAdeIdentificador;
    @XmlElementRef(name = "dataNascimento", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "valorLiberado", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorLiberado;
    @XmlElementRef(name = "codVerba", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> codVerba;
    @XmlElementRef(name = "servicoCodigo", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> servicoCodigo;
    @XmlElement(namespace = "CompraService-v1_0")
    protected int prazo;
    @XmlElementRef(name = "carencia", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "correspondenteCodigo", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> correspondenteCodigo;
    @XmlElementRef(name = "valorTac", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorTac;
    @XmlElementRef(name = "indice", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> indice;
    @XmlElementRef(name = "valorIof", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorIof;
    @XmlElementRef(name = "valorMensVin", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "orgaoCodigo", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> orgaoCodigo;
    @XmlElementRef(name = "estabelecimentoCodigo", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "taxaJuros", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> taxaJuros;
    @XmlElementRef(name = "naturezaServicoCodigo", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> naturezaServicoCodigo;
    @XmlElementRef(name = "anexo", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
