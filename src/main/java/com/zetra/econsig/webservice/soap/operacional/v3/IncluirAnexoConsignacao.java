...
@XmlRootElement(name = "incluirAnexoConsignacao", namespace = "HostaHostService-v3_0")
public class IncluirAnexoConsignacao {
    ...
    @XmlElementRef(name = "descricaoAnexo", namespace = "HostaHostService-v3_0", type = JAXBElement.class, required = false)
