...
@XmlRootElement(name = "incluirAnexoConsignacao", namespace = "HostaHostService-v1_0")
public class IncluirAnexoConsignacao {
    ...
    @XmlElementRef(name = "descricaoAnexo", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
