 ...
 *         <element name="convenios" type="{Convenio}Convenio" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "consultarConvenioResponse", namespace = "FolhaService-v1_0")
public class ConsultarConvenioResponse {
     ...
     * This is why there is not a {@code set} method for the convenios property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the convenios property.
     */
