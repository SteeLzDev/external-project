...
@XmlRootElement(name = "consultarParametrosResponse", namespace = "HostaHostService-v7_0")
public class ConsultarParametrosResponse {
    ...
    @XmlElementRef(name = "parametroSet", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
