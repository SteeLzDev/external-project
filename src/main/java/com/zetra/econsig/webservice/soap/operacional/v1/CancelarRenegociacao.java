...
@XmlRootElement(name = "cancelarRenegociacao", namespace = "HostaHostService-v1_0")
public class CancelarRenegociacao {
    ...
    @XmlElementRef(name = "codigoMotivoOperacao", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> codigoMotivoOperacao;
    @XmlElementRef(name = "obsMotivoOperacao", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
