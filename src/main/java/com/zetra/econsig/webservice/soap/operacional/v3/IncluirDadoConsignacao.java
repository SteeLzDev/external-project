...
@XmlRootElement(name = "incluirDadoConsignacao", namespace = "HostaHostService-v3_0")
public class IncluirDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoValor", namespace = "HostaHostService-v3_0", type = JAXBElement.class, required = false)
