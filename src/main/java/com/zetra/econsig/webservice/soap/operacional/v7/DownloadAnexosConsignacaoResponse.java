 ...
 *         <element name="anexos" type="{AnexoConsignacao}AnexoConsignacao" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "downloadAnexosConsignacaoResponse", namespace = "HostaHostService-v7_0")
public class DownloadAnexosConsignacaoResponse {
    ...
    protected List<AnexoConsignacao> anexos;
     ...
     * This is why there is not a {@code set} method for the anexos property.
     * 
     * <p>
     ...
     * {@link AnexoConsignacao }
     * 
     * 
     * @return
     *     The value of the anexos property.
     */
    public List<AnexoConsignacao> getAnexos() {
        if (anexos == null) {
