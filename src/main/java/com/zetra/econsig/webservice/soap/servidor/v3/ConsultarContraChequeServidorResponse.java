 ...
 *         <element name="contracheque" type="{Contracheque}Contracheque" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "consultarContraChequeServidorResponse", namespace = "ServidorService-v3_0")
public class ConsultarContraChequeServidorResponse {
    ...
    @XmlElementRef(name = "contracheque", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Contracheque> contracheque;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Contracheque }{@code >}
     *     
     */
    public JAXBElement<Contracheque> getContracheque() {
        return contracheque;
    }
     ...
     *     
     */
    public void setContracheque(JAXBElement<Contracheque> value) {
