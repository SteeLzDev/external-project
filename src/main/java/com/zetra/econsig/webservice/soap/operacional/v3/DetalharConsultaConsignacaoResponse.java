...
@XmlRootElement(name = "detalharConsultaConsignacaoResponse", namespace = "HostaHostService-v3_0")
public class DetalharConsultaConsignacaoResponse {
    ...
    @XmlElementRef(name = "boleto", namespace = "HostaHostService-v3_0", type = JAXBElement.class, required = false)
