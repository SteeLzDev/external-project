...
@XmlRootElement(name = "consultarMargem", namespace = "HostaHostService-v4_0")
public class ConsultarMargem {
    ...
    @XmlElementRef(name = "matriculaMultipla", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
