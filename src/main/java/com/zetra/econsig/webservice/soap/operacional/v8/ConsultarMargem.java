...
@XmlRootElement(name = "consultarMargem", namespace = "HostaHostService-v8_0")
public class ConsultarMargem {
    ...
    @XmlElementRef(name = "matriculaMultipla", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
