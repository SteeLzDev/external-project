...
@XmlRootElement(name = "incluirAnexoConsignacao", namespace = "HostaHostService-v7_0")
public class IncluirAnexoConsignacao {
    ...
    @XmlElementRef(name = "descricaoAnexo", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
