...
@XmlRootElement(name = "cadastrarServidorResponse", namespace = "HostaHostService-v4_0")
public class CadastrarServidorResponse {
    ...
    @XmlElementRef(name = "servidor", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
