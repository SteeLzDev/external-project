...
@XmlRootElement(name = "cadastrarServidorResponse", namespace = "HostaHostService-v7_0")
public class CadastrarServidorResponse {
    ...
    @XmlElementRef(name = "servidor", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
