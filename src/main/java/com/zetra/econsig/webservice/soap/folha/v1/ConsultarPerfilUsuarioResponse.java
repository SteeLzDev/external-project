 ...
 *         <element name="perfil" type="{Perfil}Perfil" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "consultarPerfilUsuarioResponse", namespace = "FolhaService-v1_0")
public class ConsultarPerfilUsuarioResponse {
     ...
     * This is why there is not a {@code set} method for the perfil property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the perfil property.
     */
