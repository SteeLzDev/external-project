...
@XmlRootElement(name = "consultarOrgao", namespace = "FolhaService-v1_0")
public class ConsultarOrgao {

    @XmlElement(namespace = "FolhaService-v1_0", required = true)
    protected java.lang.String usuario;
    @XmlElement(namespace = "FolhaService-v1_0", required = true)
    protected java.lang.String senha;
    @XmlElementRef(name = "codigoOrgao", namespace = "FolhaService-v1_0", type = JAXBElement.class, required = false)
