...
@XmlRootElement(name = "consultarMargemServidor", namespace = "ServidorService-v1_0")
public class ConsultarMargemServidor {
    ...
    @XmlElementRef(name = "codVerba", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
