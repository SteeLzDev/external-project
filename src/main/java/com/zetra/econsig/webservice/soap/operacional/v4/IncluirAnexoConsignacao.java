...
@XmlRootElement(name = "incluirAnexoConsignacao", namespace = "HostaHostService-v4_0")
public class IncluirAnexoConsignacao {
    ...
    @XmlElementRef(name = "descricaoAnexo", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
