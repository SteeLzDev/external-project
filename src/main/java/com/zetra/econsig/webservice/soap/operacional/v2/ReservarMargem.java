...
@XmlRootElement(name = "reservarMargem", namespace = "HostaHostService-v2_0")
public class ReservarMargem {
    ...
    @XmlElementRef(name = "prazo", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "taxaJuros", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
