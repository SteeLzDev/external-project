 ...
 *         <element name="dados" type="{DadoConsignacao}DadoConsignacao" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "incluirDadoConsignacaoResponse", namespace = "HostaHostService-v2_0")
public class IncluirDadoConsignacaoResponse {
    ...
    protected List<DadoConsignacao> dados;
    @XmlElement(namespace = "HostaHostService-v2_0", nillable = true)
     ...
     * {@link DadoConsignacao }
     * 
     * 
     * @return
     *     The value of the dados property.
     */
    public List<DadoConsignacao> getDados() {
        if (dados == null) {
            dados = new ArrayList<>();
        }
        return this.dados;
