...
@XmlRootElement(name = "consultarContraChequeServidorResponse", namespace = "ServidorService-v2_0")
public class ConsultarContraChequeServidorResponse {
    ...
    @XmlElementRef(name = "contracheque", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
