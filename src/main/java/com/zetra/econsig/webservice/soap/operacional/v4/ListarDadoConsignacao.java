...
@XmlRootElement(name = "listarDadoConsignacao", namespace = "HostaHostService-v4_0")
public class ListarDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoCodigo", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
