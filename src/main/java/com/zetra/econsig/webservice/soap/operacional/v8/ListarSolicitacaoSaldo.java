 ...
 *         <element name="dataInicioSolicitacao" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/>
 *         <element name="dataFimSolicitacao" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/>
 *         <element name="saldoExclusao" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         <element name="saldoLiquidacao" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         <element name="saldoInformacao" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "listarSolicitacaoSaldo", namespace = "HostaHostService-v8_0")
public class ListarSolicitacaoSaldo {
    ...
    @XmlElementRef(name = "dataInicioSolicitacao", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInicioSolicitacao;
    @XmlElementRef(name = "dataFimSolicitacao", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataFimSolicitacao;
    @XmlElement(namespace = "HostaHostService-v8_0")
    protected boolean saldoExclusao;
    @XmlElement(namespace = "HostaHostService-v8_0")
    protected boolean saldoLiquidacao;
    @XmlElement(namespace = "HostaHostService-v8_0")
    protected boolean saldoInformacao;
    ...
    /**
     * Gets the value of the dataInicioSolicitacao property.
     *
     * @return
     *     possible object is
     ...
     *
     */
    public JAXBElement<XMLGregorianCalendar> getDataInicioSolicitacao() {
        return dataInicioSolicitacao;
    }

    /**
     * Sets the value of the dataInicioSolicitacao property.
     *
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *
     */
    public void setDataInicioSolicitacao(JAXBElement<XMLGregorianCalendar> value) {
        dataInicioSolicitacao = value;
    }

    /**
     * Gets the value of the dataFimSolicitacao property.
     *
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *
     */
    public JAXBElement<XMLGregorianCalendar> getDataFimSolicitacao() {
        return dataFimSolicitacao;
    }

    /**
     * Sets the value of the dataFimSolicitacao property.
     *
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *
     */
    public void setDataFimSolicitacao(JAXBElement<XMLGregorianCalendar> value) {
        dataFimSolicitacao = value;
    }

    /**
     * Gets the value of the saldoExclusao property.
     *
     */
    public boolean isSaldoExclusao() {
        return saldoExclusao;
    }

    /**
     * Sets the value of the saldoExclusao property.
     *
     */
    public void setSaldoExclusao(boolean value) {
        saldoExclusao = value;
    }

    /**
     * Gets the value of the saldoLiquidacao property.
     *
     */
    public boolean isSaldoLiquidacao() {
        return saldoLiquidacao;
    }

    /**
     * Sets the value of the saldoLiquidacao property.
     *
     */
    public void setSaldoLiquidacao(boolean value) {
        saldoLiquidacao = value;
    }

    /**
     * Gets the value of the saldoInformacao property.
     *
     */
    public boolean isSaldoInformacao() {
        return saldoInformacao;
    }

    /**
     * Sets the value of the saldoInformacao property.
     *
     */
    public void setSaldoInformacao(boolean value) {
        saldoInformacao = value;
    }
