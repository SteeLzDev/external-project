...
@XmlRootElement(name = "simularConsignacaoServidor", namespace = "ServidorService-v3_0")
public class SimularConsignacaoServidor {
    ...
    @XmlElementRef(name = "valorParcela", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> valorParcela;
    @XmlElementRef(name = "valorLiberado", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> valorLiberado;
    @XmlElementRef(name = "prazo", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
