...
@XmlRootElement(name = "listarSolicitacaoResponse", namespace = "HostaHostService-v2_0")
public class ListarSolicitacaoResponse {
     ...
     * This is why there is not a {@code set} method for the solicitacoes property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the solicitacoes property.
     */
