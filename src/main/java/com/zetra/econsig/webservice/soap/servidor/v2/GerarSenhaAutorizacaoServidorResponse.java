...
@XmlRootElement(name = "gerarSenhaAutorizacaoServidorResponse", namespace = "ServidorService-v2_0")
public class GerarSenhaAutorizacaoServidorResponse {
    ...
    @XmlElementRef(name = "senhaServidor", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
