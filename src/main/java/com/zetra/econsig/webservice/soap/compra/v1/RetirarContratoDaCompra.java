...
@XmlRootElement(name = "retirarContratoDaCompra", namespace = "CompraService-v1_0")
public class RetirarContratoDaCompra {
    ...
    @XmlElementRef(name = "codigoMotivoOperacao", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> codigoMotivoOperacao;
    @XmlElementRef(name = "obsMotivoOperacao", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
