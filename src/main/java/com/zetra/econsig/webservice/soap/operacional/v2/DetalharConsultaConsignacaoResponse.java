...
@XmlRootElement(name = "detalharConsultaConsignacaoResponse", namespace = "HostaHostService-v2_0")
public class DetalharConsultaConsignacaoResponse {
    ...
    @XmlElementRef(name = "boleto", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
