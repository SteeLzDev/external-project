...
@XmlRootElement(name = "liquidarParcela", namespace = "HostaHostService-v7_0")
public class LiquidarParcela {
    ...
    @XmlElementRef(name = "prdNumero", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Short> prdNumero;
    @XmlElementRef(name = "dataDesconto", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
