...
@XmlRootElement(name = "consultarMargemServidor", namespace = "ServidorService-v2_0")
public class ConsultarMargemServidor {
    ...
    @XmlElementRef(name = "codVerba", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
