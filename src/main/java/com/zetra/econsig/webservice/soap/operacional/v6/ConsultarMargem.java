...
@XmlRootElement(name = "consultarMargem", namespace = "HostaHostService-v6_0")
public class ConsultarMargem {
    ...
    @XmlElementRef(name = "matriculaMultipla", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
