...
@XmlRootElement(name = "reservarMargem", namespace = "HostaHostService-v6_0")
public class ReservarMargem {
    ...
    @XmlElementRef(name = "prazo", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Integer> prazo;
    @XmlElementRef(name = "valorLiberado", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorLiberado;
    @XmlElementRef(name = "codVerba", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "carencia", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Integer> carencia;
    @XmlElementRef(name = "valorTac", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "valorIof", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorIof;
    @XmlElementRef(name = "valorMensVin", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "taxaJuros", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> taxaJuros;
    @XmlElementRef(name = "naturezaServicoCodigo", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "anexo", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
