 ...
 *         <element name="Estabelecimento" type="{Estabelecimento}Estabelecimento"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "cadastrarEstabelecimento", namespace = "FolhaService-v1_0")
public class CadastrarEstabelecimento {
    ...
    @XmlElement(name = "Estabelecimento", namespace = "FolhaService-v1_0", required = true)
     ...
     *     
     */
    public void setEstabelecimento(Estabelecimento value) {
