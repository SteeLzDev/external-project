...
@XmlRootElement(name = "simularConsignacaoServidorResponse", namespace = "ServidorService-v3_0")
public class SimularConsignacaoServidorResponse {
    ...
    @XmlElementRef(name = "podeSolicitar", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> podeSolicitar;
    @XmlElementRef(name = "podeSimular", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> podeSimular;
    @XmlElement(namespace = "ServidorService-v3_0", nillable = true)
