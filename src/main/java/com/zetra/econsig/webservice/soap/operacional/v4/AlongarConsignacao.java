...
@XmlRootElement(name = "alongarConsignacao", namespace = "HostaHostService-v4_0")
public class AlongarConsignacao {
    ...
    @XmlElementRef(name = "novoAdeIdentificador", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
