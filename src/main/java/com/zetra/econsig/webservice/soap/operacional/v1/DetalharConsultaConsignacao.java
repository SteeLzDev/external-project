...
@XmlRootElement(name = "detalharConsultaConsignacao", namespace = "HostaHostService-v1_0")
public class DetalharConsultaConsignacao {
    ...
    @XmlElementRef(name = "correspondenteCodigo", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "codigoVerba", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> codigoVerba;
    @XmlElementRef(name = "sdvSolicitado", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitado;
    @XmlElementRef(name = "sdvSolicitadoNaoCadastrado", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitadoNaoCadastrado;
    @XmlElementRef(name = "sdvSolicitadoCadastrado", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitadoCadastrado;
    @XmlElementRef(name = "sdvNaoSolicitado", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvNaoSolicitado;
    @XmlElementRef(name = "periodo", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> periodo;
    @XmlElementRef(name = "dataInclusaoInicio", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInclusaoInicio;
    @XmlElementRef(name = "dataInclusaoFim", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInclusaoFim;
    @XmlElementRef(name = "integraFolha", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Short> integraFolha;
    @XmlElementRef(name = "codigoMargem", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Short> codigoMargem;
    @XmlElementRef(name = "indice", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> indice;
    @XmlElementRef(name = "situacaoContrato", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<SituacaoContrato> situacaoContrato;
    @XmlElementRef(name = "situacaoServidor", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
