...
@XmlRootElement(name = "detalharConsultaConsignacao", namespace = "HostaHostService-v4_0")
public class DetalharConsultaConsignacao {
    ...
    @XmlElementRef(name = "adeNumero", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "codigoVerba", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> codigoVerba;
    @XmlElementRef(name = "sdvSolicitado", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitado;
    @XmlElementRef(name = "sdvSolicitadoNaoCadastrado", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitadoNaoCadastrado;
    @XmlElementRef(name = "sdvSolicitadoCadastrado", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitadoCadastrado;
    @XmlElementRef(name = "sdvNaoSolicitado", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "dataInclusaoInicio", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInclusaoInicio;
    @XmlElementRef(name = "dataInclusaoFim", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInclusaoFim;
    @XmlElementRef(name = "integraFolha", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Short> integraFolha;
    @XmlElementRef(name = "codigoMargem", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "situacaoContrato", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<SituacaoContrato> situacaoContrato;
    @XmlElementRef(name = "situacaoServidor", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
