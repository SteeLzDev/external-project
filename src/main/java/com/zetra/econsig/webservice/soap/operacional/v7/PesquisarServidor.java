...
@XmlRootElement(name = "pesquisarServidor", namespace = "HostaHostService-v7_0")
public class PesquisarServidor {
    ...
    @XmlElementRef(name = "estIdentificador", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> estIdentificador;
    @XmlElementRef(name = "orgIdentificador", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
