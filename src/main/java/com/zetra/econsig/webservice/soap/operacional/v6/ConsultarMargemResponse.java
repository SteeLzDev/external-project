...
@XmlRootElement(name = "consultarMargemResponse", namespace = "HostaHostService-v6_0")
public class ConsultarMargemResponse {

    @XmlElement(namespace = "HostaHostService-v6_0")
    protected boolean sucesso;
    @XmlElementRef(name = "codRetorno", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
