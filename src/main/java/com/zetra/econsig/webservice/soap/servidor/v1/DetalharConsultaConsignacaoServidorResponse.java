...
@XmlRootElement(name = "detalharConsultaConsignacaoServidorResponse", namespace = "ServidorService-v1_0")
public class DetalharConsultaConsignacaoServidorResponse {
    ...
    @XmlElementRef(name = "boleto", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Boleto> boleto;
    @XmlElement(namespace = "ServidorService-v1_0", nillable = true)
