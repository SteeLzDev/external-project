...
@XmlRootElement(name = "consultarConsignacaoParaCompraResponse", namespace = "CompraService-v1_0")
public class ConsultarConsignacaoParaCompraResponse {

    @XmlElement(namespace = "CompraService-v1_0")
    protected boolean sucesso;
    @XmlElementRef(name = "codRetorno", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "boleto", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
