...
@XmlRootElement(name = "alongarConsignacao", namespace = "HostaHostService-v2_0")
public class AlongarConsignacao {
    ...
    @XmlElementRef(name = "novoAdeIdentificador", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> novoAdeIdentificador;
    @XmlElementRef(name = "dataNascimento", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "valorLiberado", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorLiberado;
    @XmlElementRef(name = "codVerba", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    ...
    @XmlElement(namespace = "HostaHostService-v2_0")
    protected int prazo;
    @XmlElementRef(name = "carencia", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "valorTac", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "valorIof", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorIof;
    @XmlElementRef(name = "valorMensVin", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "banco", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> banco;
    @XmlElementRef(name = "agencia", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> agencia;
    @XmlElementRef(name = "conta", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> conta;
    @XmlElementRef(name = "naturezaServicoCodigo", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
