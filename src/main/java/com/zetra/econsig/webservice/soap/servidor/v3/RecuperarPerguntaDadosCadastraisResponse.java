...
@XmlRootElement(name = "recuperarPerguntaDadosCadastraisResponse", namespace = "ServidorService-v3_0")
public class RecuperarPerguntaDadosCadastraisResponse {
    ...
    @XmlElementRef(name = "numeroPergunta", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> numeroPergunta;
    @XmlElementRef(name = "textoPergunta", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
