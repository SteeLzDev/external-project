...
@XmlRootElement(name = "cadastrarTaxaDeJuros", namespace = "HostaHostService-v7_0")
public class CadastrarTaxaDeJuros {
     ...
     * This is why there is not a {@code set} method for the taxaDeJuros property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the taxaDeJuros property.
     */
    public List<TaxaDeJuros> getTaxaDeJuros() {
        if (taxaDeJuros == null) {
            taxaDeJuros = new ArrayList<>();
        }
