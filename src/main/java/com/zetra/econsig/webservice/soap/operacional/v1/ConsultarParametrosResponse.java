...
@XmlRootElement(name = "consultarParametrosResponse", namespace = "HostaHostService-v1_0")
public class ConsultarParametrosResponse {
    ...
    @XmlElementRef(name = "parametroSet", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
