 ...
 *         <element name="consignatarias" type="{Consignataria}Consignataria" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "consultarConsignatariaResponse", namespace = "FolhaService-v1_0")
public class ConsultarConsignatariaResponse {
    ...
    @XmlElement(namespace = "FolhaService-v1_0", nillable = true)
    protected List<Consignataria> consignatarias;
    ...
    /**
     * Gets the value of the consignatarias property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the consignatarias property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getConsignatarias().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the consignatarias property.
     */
    public List<Consignataria> getConsignatarias() {
        if (consignatarias == null) {
            consignatarias = new ArrayList<>();
        }
        return this.consignatarias;
    }
