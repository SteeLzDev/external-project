...
@XmlRootElement(name = "detalharConsultaConsignacaoResponse", namespace = "HostaHostService-v4_0")
public class DetalharConsultaConsignacaoResponse {
    ...
    @XmlElementRef(name = "boleto", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
