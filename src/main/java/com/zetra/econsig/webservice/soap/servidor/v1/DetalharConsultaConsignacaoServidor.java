...
@XmlRootElement(name = "detalharConsultaConsignacaoServidor", namespace = "ServidorService-v1_0")
public class DetalharConsultaConsignacaoServidor {
    ...
    @XmlElementRef(name = "adeNumero", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> adeNumero;
    @XmlElementRef(name = "adeIdentificador", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> adeIdentificador;
    @XmlElementRef(name = "consignatariaCodigo", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> consignatariaCodigo;
    @XmlElementRef(name = "correspondenteCodigo", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "codigoVerba", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codigoVerba;
    @XmlElementRef(name = "sdvSolicitado", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> sdvSolicitado;
    @XmlElementRef(name = "sdvSolicitadoNaoCadastrado", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> sdvSolicitadoNaoCadastrado;
    @XmlElementRef(name = "sdvSolicitadoCadastrado", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> sdvSolicitadoCadastrado;
    @XmlElementRef(name = "sdvNaoSolicitado", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> sdvNaoSolicitado;
    @XmlElementRef(name = "periodo", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> periodo;
    @XmlElementRef(name = "dataInclusaoInicio", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInclusaoInicio;
    @XmlElementRef(name = "dataInclusaoFim", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInclusaoFim;
    @XmlElementRef(name = "integraFolha", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> integraFolha;
    @XmlElementRef(name = "codigoMargem", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Short> codigoMargem;
    @XmlElementRef(name = "indice", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> indice;
    @XmlElementRef(name = "situacaoContrato", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
