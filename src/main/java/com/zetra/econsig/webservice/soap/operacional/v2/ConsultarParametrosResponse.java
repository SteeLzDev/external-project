...
@XmlRootElement(name = "consultarParametrosResponse", namespace = "HostaHostService-v2_0")
public class ConsultarParametrosResponse {
    ...
    @XmlElementRef(name = "parametroSet", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
