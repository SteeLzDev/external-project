...
@XmlRootElement(name = "incluirDadoConsignacao", namespace = "HostaHostService-v8_0")
public class IncluirDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoValor", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
