...
@XmlRootElement(name = "detalharConsultaConsignacaoServidorResponse", namespace = "ServidorService-v3_0")
public class DetalharConsultaConsignacaoServidorResponse {
    ...
    @XmlElementRef(name = "boleto", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
