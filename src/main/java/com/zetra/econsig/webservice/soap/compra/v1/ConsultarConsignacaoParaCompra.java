...
@XmlRootElement(name = "consultarConsignacaoParaCompra", namespace = "CompraService-v1_0")
public class ConsultarConsignacaoParaCompra {
    ...
    @XmlElementRef(name = "adeIdentificador", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "senhaServidor", namespace = "CompraService-v1_0", type = JAXBElement.class, required = false)
