...
@XmlRootElement(name = "alterarConsignacao", namespace = "HostaHostService-v7_0")
public class AlterarConsignacao {
    ...
    @XmlElement(namespace = "HostaHostService-v7_0")
    protected int prazo;
    @XmlElementRef(name = "senhaServidor", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
