...
@XmlRootElement(name = "gerarSenhaAutorizacaoServidorResponse", namespace = "ServidorService-v1_0")
public class GerarSenhaAutorizacaoServidorResponse {
    ...
    @XmlElementRef(name = "senhaServidor", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
