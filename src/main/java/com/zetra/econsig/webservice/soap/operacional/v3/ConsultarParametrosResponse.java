...
@XmlRootElement(name = "consultarParametrosResponse", namespace = "HostaHostService-v3_0")
public class ConsultarParametrosResponse {
    ...
    @XmlElementRef(name = "parametroSet", namespace = "HostaHostService-v3_0", type = JAXBElement.class, required = false)
