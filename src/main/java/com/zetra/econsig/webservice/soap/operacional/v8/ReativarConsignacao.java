...
@XmlRootElement(name = "reativarConsignacao", namespace = "HostaHostService-v8_0")
public class ReativarConsignacao {
    ...
    @XmlElementRef(name = "loginServidor", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> loginServidor;
    ...
    @XmlElementRef(name = "tokenAutServidor", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> tokenAutServidor;
     ...
     *
     */
    public JAXBElement<java.lang.String> getLoginServidor() {
     ...
     *
     */
    public void setLoginServidor(JAXBElement<java.lang.String> value) {
        loginServidor = value;
    }
     ...
     *
     */
    public JAXBElement<java.lang.String> getTokenAutServidor() {
     ...
     *
     */
    public void setTokenAutServidor(JAXBElement<java.lang.String> value) {
        tokenAutServidor = value;
    }
