...
@XmlRootElement(name = "reservarMargem", namespace = "HostaHostService-v4_0")
public class ReservarMargem {
    ...
    @XmlElementRef(name = "servicoCodigo", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "prazo", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Integer> prazo;
    @XmlElementRef(name = "valorLiberado", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorLiberado;
    @XmlElementRef(name = "codVerba", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> codVerba;
    @XmlElementRef(name = "correspondenteCodigo", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> correspondenteCodigo;
    @XmlElementRef(name = "carencia", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Integer> carencia;
    @XmlElementRef(name = "valorTac", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorTac;
    @XmlElementRef(name = "indice", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> indice;
    @XmlElementRef(name = "valorIof", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorIof;
    @XmlElementRef(name = "valorMensVin", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorMensVin;
    @XmlElementRef(name = "adeIdentificador", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "taxaJuros", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> taxaJuros;
    @XmlElementRef(name = "naturezaServicoCodigo", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> naturezaServicoCodigo;
    @XmlElementRef(name = "periodo", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> periodo;
    @XmlElementRef(name = "anexo", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
