...
@XmlRootElement(name = "downloadAnexosConsignacao", namespace = "HostaHostService-v8_0")
public class DownloadAnexosConsignacao {
    ...
    @XmlElementRef(name = "nomeArquivo", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> nomeArquivo;
    @XmlElementRef(name = "compras", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> compras;
    @XmlElementRef(name = "todos", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
