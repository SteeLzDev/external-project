...
@XmlRootElement(name = "detalharConsultaConsignacao", namespace = "HostaHostService-v8_0")
public class DetalharConsultaConsignacao {
    ...
    @XmlElementRef(name = "sdvSolicitado", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitado;
    @XmlElementRef(name = "sdvSolicitadoNaoCadastrado", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitadoNaoCadastrado;
    @XmlElementRef(name = "sdvSolicitadoCadastrado", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Boolean> sdvSolicitadoCadastrado;
    @XmlElementRef(name = "sdvNaoSolicitado", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "dataInclusaoInicio", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInclusaoInicio;
    @XmlElementRef(name = "dataInclusaoFim", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataInclusaoFim;
    @XmlElementRef(name = "integraFolha", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Short> integraFolha;
    @XmlElementRef(name = "codigoMargem", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "situacaoContrato", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<SituacaoContrato> situacaoContrato;
    @XmlElementRef(name = "situacaoServidor", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
