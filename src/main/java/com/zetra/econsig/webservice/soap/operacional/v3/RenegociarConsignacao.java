...
@XmlRootElement(name = "renegociarConsignacao", namespace = "HostaHostService-v3_0")
public class RenegociarConsignacao {
    ...
    @XmlElementRef(name = "novoAdeIdentificador", namespace = "HostaHostService-v3_0", type = JAXBElement.class, required = false)
