...
@XmlRootElement(name = "cancelarSolicitacaoServidor", namespace = "ServidorService-v3_0")
public class CancelarSolicitacaoServidor {
    ...
    @XmlElementRef(name = "codigoMotivoOperacao", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codigoMotivoOperacao;
    @XmlElementRef(name = "obsMotivoOperacao", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
