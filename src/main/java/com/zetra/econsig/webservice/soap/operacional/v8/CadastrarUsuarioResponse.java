...
@XmlRootElement(name = "cadastrarUsuarioResponse", namespace = "HostaHostService-v8_0")
public class CadastrarUsuarioResponse {
    ...
    @XmlElementRef(name = "entidadeCodigo", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> entidadeCodigo;
    @XmlElementRef(name = "entidadeNome", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> entidadeNome;
    @XmlElementRef(name = "nomeUsuario", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> nomeUsuario;
    @XmlElementRef(name = "loginUsuario", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> loginUsuario;
    @XmlElementRef(name = "senhaUsuario", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
