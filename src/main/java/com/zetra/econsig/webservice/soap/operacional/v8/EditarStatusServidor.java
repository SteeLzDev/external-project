...
@XmlRootElement(name = "editarStatusServidor", namespace = "HostaHostService-v8_0")
public class EditarStatusServidor {
    ...
    @XmlElementRef(name = "dataSaida", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataSaida;
    @XmlElementRef(name = "dataUltimoSalario", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataUltimoSalario;
    @XmlElementRef(name = "dataRetorno", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataRetorno;
    @XmlElementRef(name = "pedidoDemissao", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
