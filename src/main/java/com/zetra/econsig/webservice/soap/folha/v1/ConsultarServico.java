...
@XmlRootElement(name = "consultarServico", namespace = "FolhaService-v1_0")
public class ConsultarServico {
    ...
    @XmlElementRef(name = "codigoServico", namespace = "FolhaService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> codigoServico;
    @XmlElementRef(name = "codigoNaturezaServico", namespace = "FolhaService-v1_0", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<java.lang.String> getCodigoServico() {
     ...
     *     
     */
    public void setCodigoServico(JAXBElement<java.lang.String> value) {
