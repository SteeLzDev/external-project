...
@XmlRootElement(name = "consultarMargemServidorResponse", namespace = "ServidorService-v1_0")
public class ConsultarMargemServidorResponse {
    ...
    @XmlElementRef(name = "infoMargem", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
