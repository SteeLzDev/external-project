...
/**
 * <p>Title: OperacionalEndpointBase</p>
 * <p>Description: Base para os Endpoints de comunicação SOAP do service Operacional</p>
 * <p>Copyright: Copyright (c) 2002-2023</p>
 * <p>Company: ZetraSoft</p>
 * @author Igor Lucas, Leonel Martins
 */
@SuppressWarnings("java:S1118")
public abstract class OperacionalEndpointBase extends EndpointBase {
    ...
    protected List<RegistroRespostaRequisicaoExterna> executaOperacao(Map<CamposAPI, Object> parametros, String versaoInterface, AcessoSistema responsavel) throws ZetraException {
        return executaOperacao(CodedValues.FUN_INTEGRA_SOAP_OPERACIONAL, parametros, versaoInterface, responsavel);
    }
}