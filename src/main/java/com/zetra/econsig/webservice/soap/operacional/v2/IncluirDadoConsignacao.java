...
@XmlRootElement(name = "incluirDadoConsignacao", namespace = "HostaHostService-v2_0")
public class IncluirDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoValor", namespace = "HostaHostService-v2_0", type = JAXBElement.class, required = false)
