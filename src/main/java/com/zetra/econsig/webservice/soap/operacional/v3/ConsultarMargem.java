...
@XmlRootElement(name = "consultarMargem", namespace = "HostaHostService-v3_0")
public class ConsultarMargem {
    ...
    @XmlElementRef(name = "senhaServidor", namespace = "HostaHostService-v3_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "matriculaMultipla", namespace = "HostaHostService-v3_0", type = JAXBElement.class, required = false)
