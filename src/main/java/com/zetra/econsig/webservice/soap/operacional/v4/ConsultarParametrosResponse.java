...
@XmlRootElement(name = "consultarParametrosResponse", namespace = "HostaHostService-v4_0")
public class ConsultarParametrosResponse {
    ...
    @XmlElementRef(name = "parametroSet", namespace = "HostaHostService-v4_0", type = JAXBElement.class, required = false)
