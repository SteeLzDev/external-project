...
@XmlRootElement(name = "renegociarConsignacao", namespace = "HostaHostService-v6_0")
public class RenegociarConsignacao {
    ...
    @XmlElement(namespace = "HostaHostService-v6_0", nillable = true)
    protected List<java.lang.Long> adeNumeros;
    @XmlElement(namespace = "HostaHostService-v6_0", nillable = true)
    protected List<java.lang.String> adeIdentificador;
    @XmlElementRef(name = "novoAdeIdentificador", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
