 ...
 *         <element name="servidor" type="{Servidor}Servidor" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "cadastrarServidorResponse", namespace = "HostaHostService-v6_0")
public class CadastrarServidorResponse {
    ...
    @XmlElementRef(name = "servidor", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
    protected JAXBElement<Servidor> servidor;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Servidor }{@code >}
     *     
     */
    public JAXBElement<Servidor> getServidor() {
        return servidor;
    }
     ...
     *     
     */
    public void setServidor(JAXBElement<Servidor> value) {
        this.servidor = value;
    }
