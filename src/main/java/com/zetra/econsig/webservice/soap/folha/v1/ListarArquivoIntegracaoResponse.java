 ...
 *         <element name="arquivo" type="{Arquivo}Arquivo" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "listarArquivoIntegracaoResponse", namespace = "FolhaService-v1_0")
public class ListarArquivoIntegracaoResponse {
    ...
    @XmlElement(namespace = "FolhaService-v1_0")
    protected List<Arquivo> arquivo;
     ...
     * This is why there is not a {@code set} method for the arquivo property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the arquivo property.
     */
