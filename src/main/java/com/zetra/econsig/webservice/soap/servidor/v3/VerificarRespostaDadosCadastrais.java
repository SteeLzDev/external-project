...
@XmlRootElement(name = "verificarRespostaDadosCadastrais", namespace = "ServidorService-v3_0")
public class VerificarRespostaDadosCadastrais {
    ...
    @XmlElementRef(name = "usuario", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
