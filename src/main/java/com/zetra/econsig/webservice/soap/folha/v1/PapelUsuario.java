...
public class PapelUsuario {
    ...
    protected java.lang.Boolean cse = false;
    @XmlElement(namespace = "PapelUsuario")
    protected java.lang.Boolean org = false;
    @XmlElement(namespace = "PapelUsuario")
    protected java.lang.Boolean csa = false;
    @XmlElement(namespace = "PapelUsuario")
    protected java.lang.Boolean cor = false;
    @XmlElement(namespace = "PapelUsuario")
    protected java.lang.Boolean ser = false;
    @XmlElement(namespace = "PapelUsuario")
    protected java.lang.Boolean sup = false;
