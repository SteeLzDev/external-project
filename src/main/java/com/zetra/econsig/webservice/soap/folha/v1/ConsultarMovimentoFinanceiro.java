...
@XmlRootElement(name = "consultarMovimentoFinanceiro", namespace = "FolhaService-v1_0")
public class ConsultarMovimentoFinanceiro {
    ...
    @XmlElementRef(name = "matricula", namespace = "FolhaService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "consignatariaCodigo", namespace = "FolhaService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> consignatariaCodigo;
    @XmlElementRef(name = "servicoCodigo", namespace = "FolhaService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> servicoCodigo;
    @XmlElementRef(name = "codVerba", namespace = "FolhaService-v1_0", type = JAXBElement.class, required = false)
