...
@XmlRootElement(name = "consultarContraChequeServidorResponse", namespace = "ServidorService-v1_0")
public class ConsultarContraChequeServidorResponse {
    ...
    @XmlElementRef(name = "contracheque", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
