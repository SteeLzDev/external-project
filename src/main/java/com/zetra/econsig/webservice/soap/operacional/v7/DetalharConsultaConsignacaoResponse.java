...
@XmlRootElement(name = "detalharConsultaConsignacaoResponse", namespace = "HostaHostService-v7_0")
public class DetalharConsultaConsignacaoResponse {
    ...
    @XmlElementRef(name = "boleto", namespace = "HostaHostService-v7_0", type = JAXBElement.class, required = false)
