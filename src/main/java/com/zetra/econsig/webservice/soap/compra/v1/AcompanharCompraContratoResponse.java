 ...
 *         <element name="infoCompras" type="{InfoCompra}InfoCompra" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "acompanharCompraContratoResponse", namespace = "CompraService-v1_0")
public class AcompanharCompraContratoResponse {
    ...
    protected List<InfoCompra> infoCompras;
    ...
    /**
     * Gets the value of the infoCompras property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the infoCompras property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInfoCompras().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the infoCompras property.
     */
    public List<InfoCompra> getInfoCompras() {
        if (infoCompras == null) {
            infoCompras = new ArrayList<>();
        }
