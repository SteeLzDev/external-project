...
@XmlRootElement(name = "recuperarPerguntaDadosCadastraisResponse", namespace = "ServidorService-v1_0")
public class RecuperarPerguntaDadosCadastraisResponse {
    ...
    @XmlElementRef(name = "numeroPergunta", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> numeroPergunta;
    @XmlElementRef(name = "textoPergunta", namespace = "ServidorService-v1_0", type = JAXBElement.class, required = false)
