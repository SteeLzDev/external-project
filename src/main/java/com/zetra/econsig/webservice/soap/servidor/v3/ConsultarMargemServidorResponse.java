...
@XmlRootElement(name = "consultarMargemServidorResponse", namespace = "ServidorService-v3_0")
public class ConsultarMargemServidorResponse {
    ...
    @XmlElementRef(name = "infoMargem", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
