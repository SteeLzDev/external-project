...
@XmlRootElement(name = "listarDadoConsignacao", namespace = "HostaHostService-v3_0")
public class ListarDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoCodigo", namespace = "HostaHostService-v3_0", type = JAXBElement.class, required = false)
