...
@XmlRootElement(name = "incluirAnexoConsignacao", namespace = "HostaHostService-v6_0")
public class IncluirAnexoConsignacao {
    ...
    @XmlElementRef(name = "descricaoAnexo", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
