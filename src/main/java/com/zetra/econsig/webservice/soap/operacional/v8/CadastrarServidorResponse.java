...
@XmlRootElement(name = "cadastrarServidorResponse", namespace = "HostaHostService-v8_0")
public class CadastrarServidorResponse {
    ...
    @XmlElementRef(name = "servidor", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
