...
@XmlRootElement(name = "verificarRespostaDadosCadastrais", namespace = "ServidorService-v2_0")
public class VerificarRespostaDadosCadastrais {
    ...
    @XmlElementRef(name = "usuario", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
