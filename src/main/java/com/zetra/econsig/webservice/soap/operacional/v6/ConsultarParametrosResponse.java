...
@XmlRootElement(name = "consultarParametrosResponse", namespace = "HostaHostService-v6_0")
public class ConsultarParametrosResponse {
    ...
    @XmlElementRef(name = "parametroSet", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
