...
@XmlRootElement(name = "consultarMargem", namespace = "HostaHostService-v1_0")
public class ConsultarMargem {
    ...
    @XmlElementRef(name = "matriculaMultipla", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
