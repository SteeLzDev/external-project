...
@XmlRootElement(name = "detalharConsultaConsignacaoServidorResponse", namespace = "ServidorService-v2_0")
public class DetalharConsultaConsignacaoServidorResponse {
    ...
    @XmlElementRef(name = "boleto", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
