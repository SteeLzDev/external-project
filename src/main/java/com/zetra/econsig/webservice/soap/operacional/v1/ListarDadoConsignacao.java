...
@XmlRootElement(name = "listarDadoConsignacao", namespace = "HostaHostService-v1_0")
public class ListarDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoCodigo", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
