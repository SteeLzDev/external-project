...
@XmlRootElement(name = "incluirAnexoConsignacao", namespace = "HostaHostService-v8_0")
public class IncluirAnexoConsignacao {
    ...
    @XmlElementRef(name = "descricaoAnexo", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "tipoArquivo", namespace = "HostaHostService-v8_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> tipoArquivo;
     ...
     *     
     */
    public JAXBElement<java.lang.String> getTipoArquivo() {
        return tipoArquivo;
    }
     ...
     *     
     */
    public void setTipoArquivo(JAXBElement<java.lang.String> value) {
