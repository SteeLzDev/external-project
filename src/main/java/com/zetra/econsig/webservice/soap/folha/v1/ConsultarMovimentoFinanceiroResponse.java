 ...
 *         <element name="movimento" type="{MovimentoFinanceiro}MovimentoFinanceiro" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "consultarMovimentoFinanceiroResponse", namespace = "FolhaService-v1_0")
public class ConsultarMovimentoFinanceiroResponse {
    ...
    @XmlElement(namespace = "FolhaService-v1_0")
    protected List<MovimentoFinanceiro> movimento;
     ...
     * This is why there is not a {@code set} method for the movimento property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the movimento property.
     */
    public List<MovimentoFinanceiro> getMovimento() {
        if (movimento == null) {
