...
@XmlRootElement(name = "gerarSenhaAutorizacaoServidorResponse", namespace = "ServidorService-v3_0")
public class GerarSenhaAutorizacaoServidorResponse {
    ...
    @XmlElementRef(name = "senhaServidor", namespace = "ServidorService-v3_0", type = JAXBElement.class, required = false)
