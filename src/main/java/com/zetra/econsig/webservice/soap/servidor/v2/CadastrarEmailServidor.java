...
@XmlRootElement(name = "cadastrarEmailServidor", namespace = "ServidorService-v2_0")
public class CadastrarEmailServidor {
    ...
    @XmlElementRef(name = "banco", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> banco;
    @XmlElementRef(name = "agencia", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> agencia;
    @XmlElementRef(name = "conta", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
    protected JAXBElement<String> conta;
    @XmlElementRef(name = "exigeGrupoPerguntas", namespace = "ServidorService-v2_0", type = JAXBElement.class, required = false)
