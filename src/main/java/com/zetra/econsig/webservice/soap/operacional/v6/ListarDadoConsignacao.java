...
@XmlRootElement(name = "listarDadoConsignacao", namespace = "HostaHostService-v6_0")
public class ListarDadoConsignacao {
    ...
    @XmlElementRef(name = "dadoCodigo", namespace = "HostaHostService-v6_0", type = JAXBElement.class, required = false)
