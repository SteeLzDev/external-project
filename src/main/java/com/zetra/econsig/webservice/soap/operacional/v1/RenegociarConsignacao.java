...
@XmlRootElement(name = "renegociarConsignacao", namespace = "HostaHostService-v1_0")
public class RenegociarConsignacao {
    ...
    @XmlElementRef(name = "novoAdeIdentificador", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> novoAdeIdentificador;
    @XmlElementRef(name = "dataNascimento", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElement(namespace = "HostaHostService-v1_0")
    protected int prazo;
    @XmlElementRef(name = "carencia", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "valorTac", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "valorIof", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> valorIof;
    @XmlElementRef(name = "valorMensVin", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "banco", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> banco;
    @XmlElementRef(name = "agencia", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> agencia;
    @XmlElementRef(name = "conta", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.String> conta;
    @XmlElementRef(name = "taxaJuros", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
    protected JAXBElement<java.lang.Double> taxaJuros;
    @XmlElementRef(name = "naturezaServicoCodigo", namespace = "HostaHostService-v1_0", type = JAXBElement.class, required = false)
