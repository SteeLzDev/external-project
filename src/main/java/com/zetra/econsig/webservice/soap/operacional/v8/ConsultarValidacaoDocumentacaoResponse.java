 ...
 *         <element name="validarDocumentacao" type="{ValidarDocumentacao}ValidarDocumentacao" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "consultarValidacaoDocumentacaoResponse", namespace = "HostaHostService-v8_0")
public class ConsultarValidacaoDocumentacaoResponse {
    ...
    @XmlElement(namespace = "HostaHostService-v8_0", nillable = true)
    protected List<ValidarDocumentacao> validarDocumentacao;
    ...
    /**
     * Gets the value of the validarDocumentacao property.
     *
     * <p>This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the validarDocumentacao property.</p>
     *
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     * <pre>
     * getValidarDocumentacao().add(newItem);
     * </pre>
     *
     *
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ValidarDocumentacao }
     * </p>
     *
     *
     * @return
     *     The value of the validarDocumentacao property.
     */
    public List<ValidarDocumentacao> getValidarDocumentacao() {
        if (validarDocumentacao == null) {
            validarDocumentacao = new ArrayList<>();
        }
