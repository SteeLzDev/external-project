...
/**
 * <p>Title: InserirUsuarioConsignatariaWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Inserir Usuário Consignatária.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/inserirUsuarioCsa" })
public class InserirUsuarioConsignatariaWebController extends ConsultarUsuarioConsignatariaWebController {
    ...
    protected String getLinkAction() {
        return "../v3/inserirUsuarioCsa?acao=inserir";
    }
