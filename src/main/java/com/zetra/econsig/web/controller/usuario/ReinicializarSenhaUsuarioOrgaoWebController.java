...
/**
 * <p>Title: ReinicializarSenhaUsuarioOrgaoWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Reinicializar Senha Usuário Órgão.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/reinicializarSenhaUsuarioOrg" })
public class ReinicializarSenhaUsuarioOrgaoWebController extends ConsultarUsuarioOrgaoWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String funCodigo = CodedValues.FUN_REINICIALIZAR_SENHA_ORG;
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
