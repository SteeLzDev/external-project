...
/**
 * <p>Title: InserirUsuarioConsignanteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Inserir Usuário Consignante.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/inserirUsuarioCse" })
public class InserirUsuarioConsignanteWebController extends ConsultarUsuarioConsignanteWebController {
    ...
    protected String getLinkAction() {
        return "../v3/inserirUsuarioCse?acao=inserir";
    }
