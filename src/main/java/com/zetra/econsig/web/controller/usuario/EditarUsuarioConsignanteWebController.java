...
/**
 * <p>Title: EditarUsuarioConsignanteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Editar Usuário Consignante.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/editarUsuarioCse" })
public class EditarUsuarioConsignanteWebController extends ConsultarUsuarioConsignanteWebController {
    ...
    protected String getLinkAction() {
        return "../v3/editarUsuarioCse?acao=editar";
    }
}
