...
/**
 * <p>Title: ConsultarPerfilCseWebController</p>
 * <p>Description: Web Controller para consulta de perfil de CSE</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/consultarPerfilCse" })
public class ConsultarPerfilCseWebController extends EditarPerfilCseWebController {

    @Override
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        super.configurarPagina(request, session, model, responsavel);

        String linkAction = "../v3/consultarPerfilCse?acao=iniciar";
