...
/**
 * <p>Title: EditarPerfilCsaWebController</p>
 * <p>Description: Web Controller para edição de perfil de CSA</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/editarPerfilCsa" })
public class EditarPerfilCsaWebController extends AbstractManterPerfilWebController {
    ...
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        boolean podeEditarPerfil = responsavel.temPermissao(CodedValues.FUN_EDT_PERFIL_CSA);
        String codigo = getCodigo(request);
        List<String> perFunCodigos = null;
        String perCodigo = "";
        String perDescricao = "";
        String perVisivel = "";
        String linkAction = "../v3/manterPerfilCsa?acao=editar";
        ...
        try {
            ...
            perFunCodigos = usuarioController.getFuncaoPerfil(AcessoSistema.ENTIDADE_CSA, codigo, perCodigo, responsavel);
        ...
        try {
            exibeAutoDesbloqueio = parametroController.getParamCsa(codigo, CodedValues.TPA_AUTO_DESBLOQUEIO_USUARIO_CSA_COR, responsavel);
