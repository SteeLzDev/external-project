...
/**
 * <p>Title: ExcluirUsuarioConsignatariaWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Excluir Usuário Consignatária.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/excluirUsuarioCsa" })
public class ExcluirUsuarioConsignatariaWebController extends ConsultarUsuarioConsignatariaWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
        String funCodigo = CodedValues.FUN_EXCL_USUARIO_CSA;
