...
/**
 * <p>Title: ConsultarPerfilCsaWebController</p>
 * <p>Description: Web Controller para consulta de perfil de CSA</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/consultarPerfilCsa" })
public class ConsultarPerfilCsaWebController extends EditarPerfilCsaWebController {

    @Override
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        super.configurarPagina(request, session, model, responsavel);

        String linkAction = "../v3/consultarPerfilCsa?acao=iniciar";
