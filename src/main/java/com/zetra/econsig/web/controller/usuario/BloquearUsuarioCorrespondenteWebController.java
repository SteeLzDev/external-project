...
/**
 * <p>Title: BloquearUsuarioCorrespondenteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Bloquear/Desbloquear Usuário Correspondente.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/bloquearUsuarioCor" })
public class BloquearUsuarioCorrespondenteWebController extends ConsultarUsuarioCorrespondenteWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
        String funCodigo = CodedValues.FUN_BLOQ_DESBLOQUEAR_USUARIOS_COR;
