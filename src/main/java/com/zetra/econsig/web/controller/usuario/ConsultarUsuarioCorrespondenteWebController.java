...
/**
 * <p>Title: ConsultarUsuarioCorrespondenteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Consultar Usuário Correspondente.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/consultarUsuarioCor" })
public class ConsultarUsuarioCorrespondenteWebController extends AbstractManterUsuarioPapelWebController {
    ...
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) throws ViewHelperException {
        ...
        model.addAttribute("podeEditarBloqFunUsu", responsavel.temPermissao(CodedValues.FUN_EDT_BLOQUEIO_FUN_SER_USU_COR));
    ...
    protected boolean podeEditarUsuario(AcessoSistema responsavel) {
        return responsavel.temPermissao(CodedValues.FUN_EDT_USUARIOS_COR);
    }

    @Override
    protected String getColunaCodigoEntidade() {
        return Columns.COR_CODIGO;
    }

    @Override
    protected String getFuncaoEdicaoBloqueioFuncaoServidor() {
        return CodedValues.FUN_EDT_BLOQUEIO_FUN_SER_USU_COR;
    }
}
