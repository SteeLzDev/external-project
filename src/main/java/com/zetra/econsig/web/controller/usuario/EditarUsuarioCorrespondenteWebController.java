...
/**
 * <p>Title: EditarUsuarioCorrespondenteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Editar Usuário Correspondente.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/editarUsuarioCor" })
public class EditarUsuarioCorrespondenteWebController extends ConsultarUsuarioCorrespondenteWebController {
    ...
    protected String getLinkAction() {
        return "../v3/editarUsuarioCor?acao=editar";
    }
}
