...
/**
 * <p>Title: ConsultarPerfilCorWebController</p>
 * <p>Description: Web Controller para consulta de perfil de COR</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/consultarPerfilCor" })
public class ConsultarPerfilCorWebController extends EditarPerfilCorWebController {

    @Override
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        super.configurarPagina(request, session, model, responsavel);

        String linkAction = "../v3/consultarPerfilCor?acao=iniciar";
