...
/**
 * <p>Title: BloquearUsuarioOrgaoWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Bloquear/Desbloquear Usuário Órgão.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/bloquearUsuarioOrg" })
public class BloquearUsuarioOrgaoWebController extends ConsultarUsuarioOrgaoWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
        String funCodigo = CodedValues.FUN_BLOQ_DESBLOQUEAR_USUARIOS_ORG;
