...
/**
 * <p>Title: ReinicializarSenhaUsuarioConsignanteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Reinicializar Senha Usuário Consignante.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/reinicializarSenhaUsuarioCse" })
public class ReinicializarSenhaUsuarioConsignanteWebController extends ConsultarUsuarioConsignanteWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String funCodigo = CodedValues.FUN_REINICIALIZAR_SENHA_CSE;
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
