...
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/inserirPerfilCse" })
public class InserirPerfilCseWebController extends AbstractManterPerfilWebController {
    
    @Override
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        boolean podeEditarPerfil = responsavel.temPermissao(CodedValues.FUN_EDT_PERFIL_CSE);
        String linkAction = "../v3/manterPerfilCse?acao=inserir";
