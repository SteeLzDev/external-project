...
/**
 * <p>Title: EditarPerfilOrgWebController</p>
 * <p>Description: Web Controller para edição de perfil de ORG</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/editarPerfilOrg" })
public class EditarPerfilOrgWebController extends AbstractManterPerfilWebController {
    ...
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        boolean podeEditarPerfil = responsavel.temPermissao(CodedValues.FUN_EDT_PERFIL_ORG);
        String codigo = getCodigo(request);
        List<String> perFunCodigos = null;
        String perCodigo = "";
        String perDescricao = "";
        String perVisivel = "";
        String linkAction = "../v3/manterPerfilOrg?acao=editar";
        ...
        try {
            ...
            perFunCodigos = usuarioController.getFuncaoPerfil(AcessoSistema.ENTIDADE_ORG, codigo, perCodigo, responsavel);
