...
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/inserirPerfilOrg" })
public class InserirPerfilOrgWebController extends AbstractManterPerfilWebController {
    
    @Override
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        boolean podeEditarPerfil = responsavel.temPermissao(CodedValues.FUN_EDT_PERFIL_ORG);
        String linkAction = "../v3/manterPerfilOrg?acao=inserir";
