...
/**
 * <p>Title: EditarPerfilSupWebController</p>
 * <p>Description: Web Controller para edição de perfil de SUP</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/editarPerfilSup" })
public class EditarPerfilSupWebController extends AbstractManterPerfilWebController {
    ...
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        ...
        String perDescricao = "";
        String perVisivel = "";
        String linkAction = "../v3/manterPerfilSup?acao=editar";
        ...
        try {
            ...
            perFunCodigos = usuarioController.getFuncaoPerfil(AcessoSistema.ENTIDADE_SUP, codigo, perCodigo, responsavel);
