...
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/inserirPerfilCsa" })
public class InserirPerfilCsaWebController extends AbstractManterPerfilWebController {
    ...
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        ...
        String linkAction = "../v3/manterPerfilCsa?acao=inserir";
