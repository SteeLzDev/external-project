...
/**
 * <p>Title: BloquearUsuarioConsignanteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Bloquear/Desbloquear Usuário Consignante.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/bloquearUsuarioCse" })
public class BloquearUsuarioConsignanteWebController extends ConsultarUsuarioConsignanteWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
        String funCodigo = CodedValues.FUN_BLOQ_DESBLOQUEAR_USUARIOS_CSE;
