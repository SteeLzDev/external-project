...
/**
 * <p>Title: ConsultarPerfilOrgWebController</p>
 * <p>Description: Web Controller para consulta de perfil de ORG</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/consultarPerfilOrg" })
public class ConsultarPerfilOrgWebController extends EditarPerfilOrgWebController {

    @Override
    protected void configurarPagina(HttpServletRequest request, HttpSession session, Model model, AcessoSistema responsavel) {
        super.configurarPagina(request, session, model, responsavel);

        String linkAction = "../v3/consultarPerfilOrg?acao=iniciar";
