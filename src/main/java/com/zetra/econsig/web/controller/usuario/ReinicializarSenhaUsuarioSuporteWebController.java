...
/**
 * <p>Title: ReinicializarSenhaUsuarioSuporteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Reinicializar Senha Usuário Suporte.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/reinicializarSenhaUsuarioSup" })
public class ReinicializarSenhaUsuarioSuporteWebController extends ConsultarUsuarioSuporteWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String funCodigo = CodedValues.FUN_REINICIALIZAR_SENHA_SUP;
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
