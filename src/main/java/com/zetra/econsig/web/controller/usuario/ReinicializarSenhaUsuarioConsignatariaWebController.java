...
/**
 * <p>Title: ReinicializarSenhaUsuarioConsignatariaWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Reinicializar Senha Usuário Consignatária.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/reinicializarSenhaUsuarioCsa" })
public class ReinicializarSenhaUsuarioConsignatariaWebController extends ConsultarUsuarioConsignatariaWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String funCodigo = CodedValues.FUN_REINICIALIZAR_SENHA_CSA;
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
