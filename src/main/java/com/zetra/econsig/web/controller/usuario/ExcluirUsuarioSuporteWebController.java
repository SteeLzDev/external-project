...
/**
 * <p>Title: ExcluirUsuarioSuporteWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Excluir Usuário Suporte.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/excluirUsuarioSup" })
public class ExcluirUsuarioSuporteWebController extends ConsultarUsuarioSuporteWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
        String funCodigo = CodedValues.FUN_EXCL_USUARIO_SUP;
