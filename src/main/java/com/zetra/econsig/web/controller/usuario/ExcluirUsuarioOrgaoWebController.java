...
/**
 * <p>Title: ExcluirUsuarioOrgaoWebController</p>
 * <p>Description: Controlador Web base para o caso de uso Excluir Usuário Órgão.</p>
 ...
 */
@Controller
@RequestMapping(method = { RequestMethod.POST }, value = { "/v3/excluirUsuarioOrg" })
public class ExcluirUsuarioOrgaoWebController extends ConsultarUsuarioOrgaoWebController {
    ...
    public String efetivarAcao(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) {
        ...
        String usuCodigo = JspHelper.verificaVarQryStr(request, "USU_CODIGO");
        String funCodigo = CodedValues.FUN_EXCL_USUARIO_ORG;
