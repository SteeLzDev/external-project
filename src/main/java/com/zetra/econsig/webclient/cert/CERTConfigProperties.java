...
/**
 * <p>Title: CERTConfigProperties</p>
 * <p>Description: Propriedades para configuração de acesso ao microserviço CERT.</p>
 ...
 */
@Configuration
@PropertySource("classpath:CERTProperties.properties")
@ConfigurationProperties(prefix = "cert")
public class CERTConfigProperties {
