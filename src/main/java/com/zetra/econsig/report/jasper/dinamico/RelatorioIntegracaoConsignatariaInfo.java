 ...
 * $Date$
 */
public class RelatorioIntegracaoConsignatariaInfo extends DynamicReportInfo{
    /** Log object for this class. */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(RelatorioIntegracaoConsignatariaInfo.class);

    public RelatorioIntegracaoConsignatariaInfo(Relatorio relatorio) {
        super(relatorio);
    }
