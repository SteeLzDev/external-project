 ...
 * $Date$
 */
public class RelatorioSinteticoInfo extends DynamicReportInfo {
    /** Log object for this class. */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(RelatorioSinteticoInfo.class);

    public RelatorioSinteticoInfo(Relatorio relatorio) {
        super(relatorio);
    }
        ...
        try {
            ...
            if (campos != null) {
                ...
                if (campos.contains(Columns.NSE_DESCRICAO)) {
                    ColumnBuilder fixedColumnBuilder = buildColumn(ApplicationResourcesHelper.getMessage("rotulo.natureza.servico.titulo", responsavel), 60, true, "nse_descricao", String.class.getName(), borda);
                    AbstractColumn columnCor = fixedColumnBuilder.build();
                    reportBuilder.addColumn(columnCor);
                }
            }
