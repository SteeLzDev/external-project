 ...
 * $Date$
 */
public class RelatorioOcorrenciaAutorizacao extends ReportTemplate {

    public RelatorioOcorrenciaAutorizacao() {
        this.hqueries = new ReportHQuery [] {new RelatorioOcorrenciaAutorizacaoQuery()};
    }
