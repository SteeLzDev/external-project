 ...
 * <p> Description: Relatório de Consignações</p>
 ...
 * $Date$
 */
public class RelatorioConsignacao extends ReportTemplate {

    public RelatorioConsignacao() {
        hqueries = new ReportHQuery[] {new RelatorioConsignacoesQuery()};
    }
