...
/**
 * JPA entity class for "FuncaoPerfilSup"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name = "tb_funcao_perfil_sup")
@IdClass(FuncaoPerfilSupId.class)
public class FuncaoPerfilSup implements Serializable {
    ...
    private UsuarioSup usuarioSup;

    /**
     * Constructor
     */
    public FuncaoPerfilSup() {
        super();
    }
    ...
    public UsuarioSup getUsuarioSup() {
        return usuarioSup;
    }

    public void setId(FuncaoPerfilSupId id) {
