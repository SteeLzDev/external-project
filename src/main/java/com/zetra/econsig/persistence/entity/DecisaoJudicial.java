...
/**
 * JPA entity class for "DecisaoJudicial"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name = "tb_decisao_judicial")
public class DecisaoJudicial implements Serializable {
    ...
    @Column(name = "dju_data_revogacao", nullable = true)
