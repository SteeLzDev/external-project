...
/**
 * JPA entity class for "FuncaoPermitidaNca"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name = "tb_funcao_permitida_nca")
@IdClass(FuncaoPermitidaNcaId.class)
public class FuncaoPermitidaNca implements Serializable {
    ...
    public void setId(FuncaoPermitidaNcaId id) {
        setFunCodigo(id != null ? id.getFunCodigo() : null);
        setNcaCodigo(id != null ? id.getNcaCodigo() : null);
    }
}
