...
/**
 * JPA entity class for "FuncaoPerfilCsa"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name = "tb_funcao_perfil_csa")
@IdClass(FuncaoPerfilCsaId.class)
public class FuncaoPerfilCsa implements Serializable {
    ...
    private UsuarioCsa usuarioCsa;

    /**
     * Constructor
     */
    public FuncaoPerfilCsa() {
        super();
    }
    ...
    public UsuarioCsa getUsuarioCsa() {
        return usuarioCsa;
    }

    public void setId(FuncaoPerfilCsaId id) {
