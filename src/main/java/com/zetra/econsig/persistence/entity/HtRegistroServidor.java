...
/**
 * JPA entity class for "HtRegistroServidor"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name = "ht_registro_servidor")
public class HtRegistroServidor implements Serializable {
    ...
    public void setServidor(HtServidor htServidor) {
        servidor = htServidor;
        setSerCodigo(htServidor != null ? htServidor.getSerCodigo() : null);
    }

    public HtServidor getServidor() {
        return servidor;
    }
