...
/**
 * JPA entity class for "FuncaoPerfilCor"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name = "tb_funcao_perfil_cor")
@IdClass(FuncaoPerfilCorId.class)
public class FuncaoPerfilCor implements Serializable {
    ...
    private UsuarioCor usuarioCor;

    /**
     * Constructor
     */
    public FuncaoPerfilCor() {
        super();
    }
    ...
    public UsuarioCor getUsuarioCor() {
        return usuarioCor;
    }

    public void setId(FuncaoPerfilCorId id) {
