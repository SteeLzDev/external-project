...
/**
 * <p>Title: OracleArquivoFaturamentoBeneficioDAO</p>
 * <p>Description: Implementação para Oracle do DAO de ArquivoFaturamentoBeneficio</p>
 ...
 * $Date$
 */
public class OracleArquivoFaturamentoBeneficioDAO extends GenericArquivoFaturamentoBeneficioDAO {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(OracleArquivoFaturamentoBeneficioDAO.class);
    ...
    public void inserirArquivoFaturamentoBeneficio(List<String> orgCodigos, List<String> estCodigos, String periodo) throws DAOException {
        ...
        try {
            ...
            List<String> tntCodigosSubsidio = new ArrayList<>();
            ...
            List<String> tntCodigosSemFatura = new ArrayList<>();
            ...
            query.append("SUBSTR(LPAD(csa.csa_codigo, 12, '0'), 1, 12) || ");
            query.append("SUBSTR(LPAD(ROWNUM, 7, '0'), 1, 7)), ");
            query.append("csa.csa_codigo, :periodo, CURRENT_TIMESTAMP ");
