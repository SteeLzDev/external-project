...
/**
 * <p>Title: OracleParametrosDAO</p>
 * <p>Description: Implementacao do DAO de parametros para o Oracle</p>
 ...
 * $Date$
 */
public class OracleParametrosDAO extends GenericParametrosDAO {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(OracleParametrosDAO.class);
    ...
    public void ativaParamSvcCsa(String svcCodigo, String csaCodigo, List<String> tpsCodigos) throws DAOException {
        ...
        try {
            ...
            query.append(Columns.PSC_DATA_INI_VIG).append(" > TRUNC(CURRENT_DATE)");
            ...
            query.append(" SET ");
            query.append(Columns.PSC_DATA_FIM_VIG).append(" = TO_TIMESTAMP(TO_CHAR(CURRENT_DATE, 'YYYY-MM-DD') || ' 23:59:59', 'YYYY-MM-DD HH24:MI:SS'),");
            ...
            query.append("UPDATE ").append(Columns.TB_PARAM_SVC_CONSIGNATARIA);
            query.append(" SET ");
            query.append(Columns.PSC_DATA_INI_VIG).append(" = TRUNC(CURRENT_DATE + INTERVAL 1 DAY),");
