...
/**
 * <p>Title: OracleRelatorioBeneficiariosDAO</p>
 ...
 * $Date$
 */
public class OracleRelatorioBeneficiariosDAO implements RelatorioBeneficiariosDAO {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(OracleRelatorioBeneficiariosDAO.class);
     ...
     * @throws DataAccessException
     */
    private void obtemBeneficiariosEEnderecoServidorInclusaoPeriodo() throws DataAccessException, SQLException {
        final MapSqlParameterSource queryParams = new MapSqlParameterSource();
        final NamedParameterJdbcTemplate jdbc = DBHelper.getNamedParameterJdbcTemplate();
     ...
     * @throws DataAccessException
     */
    private void incluiuBeneficiariosEEnderecoServidorInclusaoPeriodoNaTabelaFinal() throws DataAccessException, SQLException {
        final StringBuilder sql = new StringBuilder();
     ...
     * @throws DataAccessException
     */
    private void obtemEnderecoServidorAlteracaoPeriodo() throws DataAccessException, SQLException {
        final MapSqlParameterSource queryParams = new MapSqlParameterSource();
        final NamedParameterJdbcTemplate jdbc = DBHelper.getNamedParameterJdbcTemplate();
     ...
     * @throws DataAccessException
     */
    private void analisaSeBeneficiarioTeveAlteracaoCamposRelatorio() throws DataAccessException, SQLException {
        final MapSqlParameterSource queryParams = new MapSqlParameterSource();
        final NamedParameterJdbcTemplate jdbc = DBHelper.getNamedParameterJdbcTemplate();
     ...
     * @throws DataAccessException
     */
    private void incluiuBeneficiariosEEnderecoServidorAlteracaoPeriodoNaTabelaFinal() throws DataAccessException, SQLException {
        Connection conn = null;
        PreparedStatement preparedStatement = null;
        try {
            conn = DBHelper.makeConnection();
