...
/**
 * <p>Title: MySqlValidacaoFaturamentoBeneficioDAO</p>
 * <p>Description: Implementação para MySQL do DAO de MySqlValidacaoFaturamentoBeneficioDAO</p>
 ...
 * $Date$
 */
public class MySqlValidacaoFaturamentoBeneficioDAO implements ValidacaoFaturamentoBeneficioDAO {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(MySqlValidacaoFaturamentoBeneficioDAO.class);
    ...
    public List<TransferObject> validarFaturamentoBeneficio(String fatCodigo, boolean validarPrevia) throws DAOException {
        ...
        try {
            ...
            final FaturamentoBeneficio fat = FaturamentoBeneficioHome.findByPrimaryKey(fatCodigo);
            final String csaCodigo = fat.getConsignataria().getCsaCodigo();
            final Date fatPeriodo = fat.getFatPeriodo();
            ...
            if (validarPrevia) {
                ...
                query.append("(csa_identificador, csa_nome, fat_periodo, rse_matricula, cbe_numero, tla_codigo, valor_debito, motivo) ");
            ...
            query.append("JOIN tb_consignataria csa ON (fat.csa_codigo = csa.csa_codigo) ");
            query.append("JOIN ( ");
            query.append("SELECT COUNT(*) AS qtde, afb2.cbe_numero, afb2.tla_codigo ");
            ...
            query.setLength(0);
            query.append("SELECT CSA_IDENTIFICADOR, CSA_NOME, FAT_PERIODO, RSE_MATRICULA, CBE_NUMERO, TLA_CODIGO, VALOR_DEBITO, MOTIVO ");
