...
/**
 * <p>Title: MySqlCalculoMargemDAO</p>
 * <p>Description: Implementação para MySql do DAO de Cálculo de Margem.</p>
 ...
 * $Date$
 */
public class MySqlCalculoMargemDAO extends GenericCalculoMargemDAO {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(MySqlCalculoMargemDAO.class);
    ...
    public void calcularMargemExtraUsada(String tipoEntidade, List<String> entCodigos, boolean controlaMargem) throws DAOException {
        ...
        try {
            ...
            String query = "update tb_margem_registro_servidor mrs "
                         + getComplementoJoin(tipoEntidade, entCodigos, "mrs")
            ...
            query = "create temporary table tmp_margem_usada "
                  + "(rse_codigo varchar(32), mar_codigo smallint, margem_usada decimal(13,2), primary key (rse_codigo, mar_codigo))";
            LOG.trace(query);
            jdbc.update(query, queryParams);
            ...
            if (!controlaMargem) {
                 ...
                 */
                query = "insert into tmp_margem_usada (rse_codigo, mar_codigo, margem_usada) "
            ...
            if (ParamSist.getBoolParamSist(CodedValues.TPC_PRENDER_MARGEM_RENEG_CONTRATRO_NOVO_MENOR_ANTIGOS, AcessoSistema.getAcessoUsuarioSistema())) {
                ...
                query = "create temporary table tmp_margem_reneg_diferenca "
                        + "(rse_codigo varchar(32), mar_codigo smallint, usada decimal(13,2), key tmpidx_rse (rse_codigo, mar_codigo))";
                LOG.trace(query);
                jdbc.update(query, queryParams);

                query = "insert into tmp_margem_usada_reneg (rse_codigo, mar_codigo, usada)"
                ...
                query = "update tmp_margem_usada tmp "
                        + "inner join tmp_margem_reneg_diferenca ren on (tmp.rse_codigo = ren.rse_codigo and tmp.mar_codigo = ren.mar_codigo) "
                        + "set tmp.margem_usada = tmp.margem_usada + ren.margem_usada "
            ...
            if(!controlaMargem && ParamSist.getBoolParamSist(CodedValues.TPC_LIBERA_MARGEM_ENVIADA_PELA_FOLHA_CONSIG_CARENCIA, AcessoSistema.getAcessoUsuarioSistema())
                ...
                query = "create temporary table tmp_margem_carencia_usada "
                        + "(rse_codigo varchar(32), mar_codigo smallint, margem_usada decimal(13,2), KEY `tmpCarenciaidx_rse` (`rse_codigo`)) "
                        + "select rse.rse_codigo, ade.ade_inc_margem as mar_codigo, sum(ade_vlr) as margem_usada "
                        + "from tb_aut_desconto ade "
                ...
                query = "update tmp_margem_usada tmpUsada "
                        ...
                        + "set tmpusada.margem_usada = tmpusada.margem_usada-tmpCarencia.margem_usada "
                        + "where tmpCarencia.mar_codigo = tmpUsada.mar_codigo";
                LOG.trace(query);
                jdbc.update(query, queryParams);
            }
            ...
            query = "create temporary table tmp_margem_usada_reneg "
                  + "(rse_codigo varchar(32), mar_codigo smallint, ade_codigo varchar(32), ade_vlr decimal(13,2), usada decimal(13,2), key tmpidx_rse (rse_codigo, mar_codigo))";
            LOG.trace(query);
            jdbc.update(query, queryParams);

            query = "insert into tmp_margem_usada_reneg (rse_codigo, mar_codigo, ade_codigo, ade_vlr, usada)"
            ...
            query = "insert into tmp_margem_reneg (rse_codigo, mar_codigo, margem_usada) "
            ...
            query = "update tmp_margem_usada tmp "
                  + "inner join tmp_margem_reneg ren on (tmp.rse_codigo = ren.rse_codigo and tmp.mar_codigo = ren.mar_codigo) "
                  + "set tmp.margem_usada = tmp.margem_usada + ren.margem_usada "
                  + "where ren.margem_usada > 0.00";
            LOG.trace(query);
            jdbc.update(query, queryParams);

            query = "delete from tmp_margem_reneg where exists ("
                  + "select 1 from tmp_margem_usada tmp where tmp.rse_codigo = tmp_margem_reneg.rse_codigo and tmp.mar_codigo = tmp_margem_reneg.mar_codigo)";
            LOG.trace(query);
            jdbc.update(query, queryParams);
            ...
            query = "update tb_margem_registro_servidor mrs "
                  + "inner join tmp_margem_usada tmp on (tmp.rse_codigo = mrs.rse_codigo and tmp.mar_codigo = mrs.mar_codigo) "
                  + "set mrs_margem_usada = margem_usada";
            LOG.trace(query);
            jdbc.update(query, queryParams);
            ...
            query = "create temporary table tmp_margem_liquidada_reneg "
                  + "(rse_codigo varchar(32), mar_codigo smallint, margem_liquidada decimal(13,2), primary key (rse_codigo, mar_codigo))";
            LOG.trace(query);
            jdbc.update(query, queryParams);

            query = "insert into tmp_margem_liquidada_reneg (rse_codigo, mar_codigo, margem_liquidada) "
            ...
            query = "update tb_margem_registro_servidor mrs "
                  + "inner join tmp_margem_liquidada_reneg tmp on (tmp.rse_codigo = mrs.rse_codigo and tmp.mar_codigo = mrs.mar_codigo) "
                  + "set mrs_margem_usada = mrs_margem_usada + margem_liquidada";
            LOG.trace(query);
            jdbc.update(query, queryParams);
            ...
            if (!controlaMargem) {
                ...
                query = "insert into tmp_margem_liquidada (rse_codigo, mar_codigo, margem_liquidada) "
                      + "select ade.rse_codigo, ade.ade_inc_margem as mar_codigo, "
                      ...
                      + " or date_add(ade_ano_mes_fim, interval coalesce(ade_carencia_final, 0) + " + carenciaFolha + " month) > pex_periodo) " : "")
                      + complementoWhere
                      + "group by ade.rse_codigo, ade.ade_inc_margem";
                LOG.trace(query);
                jdbc.update(query, queryParams);
                ...
                query = "update tb_margem_registro_servidor mrs "
                      + "inner join tmp_margem_liquidada tmp on (tmp.rse_codigo = mrs.rse_codigo and tmp.mar_codigo = mrs.mar_codigo) "
                      + "set mrs_margem_usada = mrs_margem_usada - margem_liquidada";
                LOG.trace(query);
                jdbc.update(query, queryParams);
                ...
                if (liberaMargemConclusaoContrato) {
                    ...
                    query = "create temporary table tmp_margem_concluida "
                          + "(rse_codigo varchar(32), mar_codigo smallint, margem_concluida decimal(13,2), primary key (rse_codigo, mar_codigo))";
                    LOG.trace(query);
                    jdbc.update(query, queryParams);
                    ...
                    query = "insert into tmp_margem_concluida (rse_codigo, mar_codigo, margem_concluida) "
                    ...
                    query = "update tb_margem_registro_servidor mrs "
                          + "inner join tmp_margem_concluida tmp on (tmp.rse_codigo = mrs.rse_codigo and tmp.mar_codigo = mrs.mar_codigo) "
                          + "set mrs_margem_usada = mrs_margem_usada - margem_concluida";
                    LOG.trace(query);
                    jdbc.update(query, queryParams);
                }
                ...
                query = "create temporary table tmp_margem_alterada "
                      + "(rse_codigo varchar(32), mar_codigo smallint, margem_alterada decimal(13,2), primary key (rse_codigo, mar_codigo))";
                LOG.trace(query);
                jdbc.update(query, queryParams);

                query = "insert into tmp_margem_alterada (rse_codigo, mar_codigo, margem_alterada) "
                ...
                query = "update tb_margem_registro_servidor mrs "
                      + "inner join tmp_margem_alterada tmp on (tmp.rse_codigo = mrs.rse_codigo and tmp.mar_codigo = mrs.mar_codigo) "
                      + "set mrs_margem_usada = mrs_margem_usada + margem_alterada";
                LOG.trace(query);
                jdbc.update(query, queryParams);
                ...
                query = "create temporary table tmp_margem_percentual (rse_codigo varchar(32), mar_codigo smallint, margem_usada decimal(13,2), primary key (rse_codigo, mar_codigo))";
                LOG.trace(query);
                jdbc.update(query, queryParams);

                query = "insert into tmp_margem_percentual (rse_codigo, mar_codigo, margem_usada) "
                      + "select ade.rse_codigo, ade.ade_inc_margem as mar_codigo, "
                      + "sum(coalesce(valor_pago, ade_vlr_folha) - ade_vlr) as margem_usada "
                      + "from tb_aut_desconto ade "
                      + complementoJoinEnt
                      + complementoJoinPex
                      ...
                      + "where ade.sad_codigo in ('" + TextHelper.join(CodedValues.SAD_CODIGOS_ABERTOS_INCIDEM_MARGEM_BRUTA, "','") + "') " // CONTRATO ATIVO
                      + "and ade.ade_tipo_vlr = '" + CodedValues.TIPO_VLR_PERCENTUAL + "' "  // PERCENTUAL
                      + "and ade.ade_inc_margem <> 0 "                                       // INCIDE NA MARGEM
                ...
                query = "update tb_margem_registro_servidor mrs "
                      + "inner join tmp_margem_percentual tmp on (tmp.rse_codigo = mrs.rse_codigo and tmp.mar_codigo = mrs.mar_codigo) "
                      + "set mrs_margem_usada = mrs_margem_usada + margem_usada ";
                LOG.trace(query);
                jdbc.update(query, queryParams);
            ...
            query = "insert into tmp_margem_liquidada_prz_indet (rse_codigo, mar_codigo, margem_liquidada) "
            ...
            query = "update tb_margem_registro_servidor mrs "
                  + "inner join tmp_margem_liquidada_prz_indet tmp on (tmp.rse_codigo = mrs.rse_codigo and tmp.mar_codigo = mrs.mar_codigo) "
                  + "set mrs_margem_usada = mrs_margem_usada + margem_liquidada";
            LOG.trace(query);
            jdbc.update(query, queryParams);
    ...
    public void calcularMargemExtraRestante(String tipoEntidade, List<String> entCodigos) throws DAOException {
        ...
        try {
            final String query = "update tb_margem_registro_servidor mrs "
                         ...
                         + " where 1=1 "
                         + getComplementoWhere(tipoEntidade, entCodigos, queryParams)
                         ;
            LOG.trace(query);
            jdbc.update(query, queryParams);
        ...
        try {
            ...
            for (int i = 0; i < marCodigos.size(); i++) {
                for (int j = i+1; j < marCodigos.size(); j++) {
                    ...
                    query.append(" inner join tb_margem_registro_servidor mrs").append(marCodigos.get(j)).append(" on (");
                    query.append("mrs").append(marCodigos.get(i)).append(".rse_codigo = mrs").append(marCodigos.get(j)).append(".rse_codigo");
                    query.append(") ");
                    ...
                    query.append("  + mrs").append(marCodigos.get(j)).append(".mrs_margem_usada");
            ...
            for (int i = 0; i < marCodigos.size(); i++) {
                if (i == 0) {
                    ...
                    query.setLength(0);
                    query.append("update tb_margem_registro_servidor mrs").append(marCodigos.get(i));
                    query.append(" inner join tb_margem_registro_servidor mrs").append(marCodigos.get(i-1)).append(" on (");
                    query.append("mrs").append(marCodigos.get(i)).append(".rse_codigo = mrs").append(marCodigos.get(i-1)).append(".rse_codigo");
                    query.append(") ");
                    query.append(getComplementoJoin(tipoEntidade, entCodigos, "mrs" + marCodigos.get(i)));
                    query.append("set mrs").append(marCodigos.get(i)).append(".mrs_margem_rest");
                    query.append("  = least(mrs").append(marCodigos.get(i-1)).append(".mrs_margem_rest, ");
                    query.append("          mrs").append(marCodigos.get(i)).append(".mrs_margem - mrs").append(marCodigos.get(i)).append(".mrs_margem_usada");
                    query.append(" )");
                    query.append(" where 1=1");
                    query.append(" and mrs").append(marCodigos.get(i)).append(".mar_codigo = ").append(marCodigos.get(i));
        ...
        try {
            ...
            for (int i = 0; i < marCodigos.size(); i++) {
                if (i == 0) {
                    ...
                    query.setLength(0);
                    query.append("update tb_margem_registro_servidor mrs").append(marCodigos.get(i));
                    query.append(" inner join tb_margem_registro_servidor mrs").append(marCodigos.get(0)).append(" on (");
                    query.append("mrs").append(marCodigos.get(i)).append(".rse_codigo = mrs").append(marCodigos.get(0)).append(".rse_codigo");
                    query.append(") ");
                    query.append(getComplementoJoin(tipoEntidade, entCodigos, "mrs" + marCodigos.get(i)));
                    query.append("set mrs").append(marCodigos.get(i)).append(".mrs_margem_usada");
                    query.append("  = mrs").append(marCodigos.get(0)).append(".mrs_margem_usada");
                    query.append(" where 1=1");
                    query.append(" and mrs").append(marCodigos.get(i)).append(".mar_codigo = ").append(marCodigos.get(i));
            ...
            for (final Short element : marCodigos) {
                ...
                query.append(getComplementoJoin(tipoEntidade, entCodigos, "mrs" + element));
    ...
    public void calcularMargemExtraCasadaLateral(String tipoEntidade, List<String> entCodigos, List<Short> marCodigos) throws DAOException {
        ...
        try {
            ...
            for (int i = 1; i < marCodigos.size(); i++) {
                ...
                query.append("  - mrs").append(marCodigos.get(i)).append(".mrs_margem_usada");
                query.append("  + least(0, mrs").append(marCodigos.get(i-1)).append(".mrs_margem_rest)");
                query.append(" where 1=1");
                query.append(" and mrs").append(marCodigos.get(i)).append(".mar_codigo = ").append(marCodigos.get(i));
                query.append(" and mrs").append(marCodigos.get(i-1)).append(".mar_codigo = ").append(marCodigos.get(i-1));
                query.append(getComplementoWhere(tipoEntidade, entCodigos, queryParams));
    ...
    public void calcularMediaMargem(int periodoMediaMargem) throws DAOException {
        ...
        try {
            ...
            query.append("SELECT MIN(HMP_DATA) as DATA_IMPORTACAO FROM tb_historico_margem_periodo");
            String dataImportacao = "";

            final List<TransferObject> resultado =  MySqlGenericDAO.getFieldsValuesList(queryParams, query.toString(), "DATA_IMPORTACAO", MySqlDAOFactory.SEPARADOR);
            for (final TransferObject dataImpMargem : resultado) {
               dataImportacao = DateHelper.format(DateHelper.objectToDate(dataImpMargem.getAttribute("DATA_IMPORTACAO")), "yyyy-MM-dd HH:mm:ss");
            }

            query.setLength(0);
            query.append("DROP TEMPORARY TABLE IF EXISTS tmp_media_margem_folha ");
            LOG.trace(query);
            jdbc.update(query.toString(), queryParams);
            query.setLength(0);

            query.append("CREATE TEMPORARY TABLE tmp_media_margem_folha (RSE_CODIGO varchar(32), MAR_CODIGO smallint, MEDIA decimal(13,2), primary key (RSE_CODIGO, MAR_CODIGO)) ");
            LOG.trace(query);
            jdbc.update(query.toString(), queryParams);
            query.setLength(0);

            query.append("INSERT INTO tmp_media_margem_folha (RSE_CODIGO, MAR_CODIGO, MEDIA) ");
            query.append("SELECT rse.RSE_CODIGO, hmf.MAR_CODIGO, AVG(hmf.HMA_MARGEM_FOLHA) ");
            query.append("FROM tb_historico_margem_folha hmf ");
            query.append("INNER JOIN tb_registro_servidor rse ON (rse.RSE_CODIGO = hmf.RSE_CODIGO) ");
            query.append("WHERE hmf.HMA_DATA >= DATE_SUB(CURDATE(), INTERVAL ").append(periodoMediaMargem).append(" MONTH) ");
            query.append("  AND hmf.HMA_MARGEM_FOLHA > 0 ");
            if(!TextHelper.isNull(dataImportacao)) {
                query.append("  AND rse.RSE_DATA_CARGA >= '").append(dataImportacao).append("' ");
            }
            query.append("GROUP BY rse.RSE_CODIGO, hmf.MAR_CODIGO ");
            LOG.trace(query);
            jdbc.update(query.toString(), queryParams);
            query.setLength(0);

            query.append("UPDATE tb_registro_servidor rse ");
            query.append("INNER JOIN tmp_media_margem_folha mmf ON (rse.RSE_CODIGO = mmf.RSE_CODIGO AND mmf.MAR_CODIGO='1') ");
            query.append("SET rse.RSE_MEDIA_MARGEM = mmf.MEDIA ");
            LOG.trace(query);
            jdbc.update(query.toString(), queryParams);
            query.setLength(0);

            query.append("UPDATE tb_registro_servidor rse ");
            query.append("INNER JOIN tmp_media_margem_folha mmf ON (rse.RSE_CODIGO = mmf.RSE_CODIGO AND mmf.MAR_CODIGO='2') ");
            query.append("SET rse.RSE_MEDIA_MARGEM_2 = mmf.MEDIA ");
            LOG.trace(query);
            jdbc.update(query.toString(), queryParams);
            query.setLength(0);

            query.append("UPDATE tb_registro_servidor rse ");
            query.append("INNER JOIN tmp_media_margem_folha mmf ON (rse.RSE_CODIGO = mmf.RSE_CODIGO AND mmf.MAR_CODIGO='3') ");
            query.append("SET rse.RSE_MEDIA_MARGEM_3 = mmf.MEDIA ");
            LOG.trace(query);
            jdbc.update(query.toString(), queryParams);
            query.setLength(0);

            query.append("UPDATE tb_margem_registro_servidor mrs ");
            query.append("INNER JOIN tmp_media_margem_folha mmf ON (mrs.RSE_CODIGO = mmf.RSE_CODIGO AND mrs.MAR_CODIGO = mmf.MAR_CODIGO) ");
            query.append("SET MRS_MEDIA_MARGEM = mmf.MEDIA ");
            LOG.trace(query);
            jdbc.update(query.toString(), queryParams);
            query.setLength(0);
        } catch (final DataAccessException ex) {
