 ...
 * <p>Description: Implementação para MSSql do DAO de Regra de Convênio.</p>
 ...
 * $Date$
 */
public class OracleRegraConvenioDAO implements RegraConvenioDAO {
	private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(OracleRegraConvenioDAO.class);
