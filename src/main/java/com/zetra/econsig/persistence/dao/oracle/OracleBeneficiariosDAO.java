 ...
 * $Date$
 */
public class OracleBeneficiariosDAO implements BeneficiarioDAO {
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(OracleBeneficiariosDAO.class);
