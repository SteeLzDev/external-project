 ...
 * <p>Description: Retornar lista de Emails que possuem matrícula não excluída.</p>
 ...
 * $Date$
 */
public class ListaEmailServidorQuery extends HQuery {

    @Override
    public Query<Object[]> preparar(Session session) throws HQueryException {
        StringBuilder corpoBuilder = new StringBuilder();

        corpoBuilder.append("select ser.serEmail ");
        ...
        corpoBuilder.append("group by ser.serEmail ");
        corpoBuilder.append("order by ser.serEmail ");
