...
/**
 * <p>Title: ListarProvedorBeneficioCorEmAreaGeograficaQuery</p>
 * <p>Description: Lista provedores de benefícios de COR dentro de um raio de geolocalização dado para natureza de serviços também dado.</p>
 ...
 */
public class ListarProvedorBeneficioCorEmAreaGeograficaQuery extends HNativeQuery {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(ListarProvedorBeneficioCorEmAreaGeograficaQuery.class);
    ...
    protected Query<Object[]> preparar(Session session) throws HQueryException {
        ...
        sql.append("select ").append(Columns.COR_NOME).append(", ").append(Columns.ECR_LATITUDE).append(", ").append(Columns.ECR_LONGITUDE);
        sql.append(", ").append(Columns.ECR_LOGRADOURO).append(", ").append(Columns.ECR_NUMERO).append(", ").append(Columns.ECR_COMPLEMENTO).append(", ").append(Columns.ECR_BAIRRO).append(", ").append(Columns.ECR_MUNICIPIO);
        sql.append(", ").append(Columns.ECR_UF).append(", ").append(Columns.ECR_CEP);
        sql.append(", (").append(RAIO_MEDIO_TERRA).append(" * ");
        sql.append("acos(cos(radians(").append(latReferencia).append(")) * ");
        sql.append("cos(radians(").append(Columns.ECR_LATITUDE).append(")) * ");
        sql.append("cos(radians(").append(longReferencia).append(") - radians(").append(Columns.ECR_LONGITUDE).append(")) + ");
        sql.append("sin(radians(").append(latReferencia).append(")) * ");
        sql.append("sin(radians(").append(Columns.ECR_LATITUDE).append("))");
        ...
        sql.append(" FROM ").append(Columns.TB_CORRESPONDENTE);
        sql.append(" INNER JOIN ").append(Columns.TB_CONSIGNATARIA).append(" on ").append(Columns.COR_CSA_CODIGO).append(" = ").append(Columns.CSA_CODIGO);
        ...
        sql.append(" INNER JOIN ").append(Columns.TB_BENEFICIO).append(" on ").append(Columns.BEN_COR_CODIGO).append(" = ").append(Columns.COR_CODIGO);
        sql.append(" INNER JOIN ").append(Columns.TB_ENDERECO_CORRESPONDENTE).append(" on ").append(Columns.ECR_COR_CODIGO).append(" = ").append(Columns.COR_CODIGO);
        ...
        sql.append(" WHERE ").append(Columns.COR_ATIVO).append(" = '").append(CodedValues.STS_ATIVO).append("'");
        ...
        if (!TextHelper.isNull(textoBusca)) {
            ...
            sql.append(" OR ").append(" ").append(criaClausulaNomeada(Columns.COR_NOME, "corNome", CodedValues.LIKE_MULTIPLO + textoBusca)).append(")");
        }

        sql.append(" GROUP BY ").append(Columns.COR_NOME).append(", ").append(Columns.ECR_LATITUDE).append(", ").append(Columns.ECR_LONGITUDE);
        sql.append(", ").append(Columns.ECR_LOGRADOURO).append(", ").append(Columns.ECR_NUMERO).append(", ").append(Columns.ECR_COMPLEMENTO).append(", ").append(Columns.ECR_BAIRRO).append(", ").append(Columns.ECR_MUNICIPIO);
        sql.append(", ").append(Columns.ECR_UF).append(", ").append(Columns.ECR_CEP);
        ...
        if (!TextHelper.isNull(textoBusca)) {
            ...
            defineValorClausulaNomeada("corNome", CodedValues.LIKE_MULTIPLO + textoBusca + CodedValues.LIKE_MULTIPLO, query);
        }
        ...
        if (!TextHelper.isNull((nseCodigos != null) && !nseCodigos.isEmpty())) {
