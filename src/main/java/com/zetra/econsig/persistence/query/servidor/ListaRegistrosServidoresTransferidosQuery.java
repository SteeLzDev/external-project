 ...
 * <p>Description: Lista registros servidores transferidos.</p>
 ...
 * $Date$
 */
public class ListaRegistrosServidoresTransferidosQuery extends HQuery {

    public boolean count = false;

    public ListaRegistrosServidoresTransferidosQuery() {
    }

    public ListaRegistrosServidoresTransferidosQuery(boolean count) {
        this.count = count;
    }
    ...
    public Query<Object[]> preparar(Session session) throws HQueryException {
        ...
        corpoBuilder.append(" AND ser.serCpf IN ");
