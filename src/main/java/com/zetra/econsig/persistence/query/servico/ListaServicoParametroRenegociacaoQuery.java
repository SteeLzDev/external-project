...
/**
 * <p>Title: ListaServicoParametroRenegociacaoQuery</p>
 * <p>Description: Busca os serviços com a respectiva configuração de parâmetros de
...
public class ListaServicoParametroRenegociacaoQuery extends HQuery {
    ...
    public Query<Object[]> preparar(Session session) throws HQueryException {
        final String corpo =
            ...
            corpoBuilder.append("left outer join svc.paramSvcConsignanteSet psePermiteRenegociacao WITH ");
            corpoBuilder.append("  psePermiteRenegociacao.tipoParamSvc.tpsCodigo = '").append(CodedValues.TPS_PERMITE_RENEGOCIACAO).append("' ");
            corpoBuilder.append("left outer join svc.paramSvcConsignanteSet pseQuantidadeMinParcelaPaga WITH ");
            corpoBuilder.append("  pseQuantidadeMinParcelaPaga.tipoParamSvc.tpsCodigo = '").append(CodedValues.TPS_MINIMO_PRD_PAGAS_RENEGOCIACAO).append("' ");
            corpoBuilder.append("left outer join svc.paramSvcConsignanteSet psePercentualMinParcelaPaga WITH ");
            corpoBuilder.append("   psePercentualMinParcelaPaga.tipoParamSvc.tpsCodigo = '").append(CodedValues.TPS_PERCENTUAL_MINIMO_PRD_PAGAS_RENEG).append("' ");
            corpoBuilder.append("left outer join svc.paramSvcConsignanteSet pseQuantidadeMinVigencia WITH ");
            corpoBuilder.append("   pseQuantidadeMinVigencia.tipoParamSvc.tpsCodigo = '").append(CodedValues.TPS_MINIMO_VIGENCIA_RENEG).append("' ");
            corpoBuilder.append("left outer join svc.paramSvcConsignanteSet psePercentualMinVigencia WITH ");
            corpoBuilder.append("   psePercentualMinVigencia.tipoParamSvc.tpsCodigo = '").append(CodedValues.TPS_PERCENTUAL_MINIMO_VIGENCIA_RENEG).append("' ");
            ...
            corpoBuilder.append(" and (nullif(trim(psePermiteRenegociacao.pseVlr), '') is null or ");
            corpoBuilder.append("      psePermiteRenegociacao.pseVlr = '1' )");
