...
/**
 * <p>Title: ObtemPeriodoCalendarioFolhaQuery</p>
 * <p>Description: Retorna as datas do período de lançamento
 * configuradas no calendário folha de acordo com a data passada.
 * A data passada deve estar entre a data ini e fim do período do calendário folha</p>
 ...
 * $Date$
 */
public class ObtemPeriodoCalendarioFolhaQuery extends HQuery {
    ...
    public Query<Object[]> preparar(Session session) throws HQueryException {
        ...
        corpoBuilder.append(" left outer join cse.calendarioFolhaCseSet cfc with :data between cfc.cfcDataIni and cfc.cfcDataFim ");
        corpoBuilder.append(" left outer join est.calendarioFolhaEstSet cfe with :data between cfe.cfeDataIni and cfe.cfeDataFim ");
        corpoBuilder.append(" left outer join org.calendarioFolhaOrgSet cfo with :data between cfo.cfoDataIni and cfo.cfoDataFim ");
