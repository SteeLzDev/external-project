 ...
 * $Date$
 */
public class RelatorioSinteticoGerencialCsaMediaCetCsaQuery extends ReportHQuery {
    ...
    public Query<Object[]> preparar(Session session) throws HQueryException {
        ...
        corpo.append("   to_decimal(avg(coe.cftVlr), 5, 2) as percentual");
        corpo.append(" FROM AutDesconto ade");
        corpo.append("       inner join ade.coeficienteDescontoSet cod");
        corpo.append("       inner join cod.coeficiente coe");
