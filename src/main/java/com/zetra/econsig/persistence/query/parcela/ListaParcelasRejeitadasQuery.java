 ...
 * $Date$
 */
public class ListaParcelasRejeitadasQuery extends HQuery {
	...
	public ListaParcelasRejeitadasQuery(String periodo, String idUsuario, List<String> orgCodigo, List<String> estCodigo, boolean notificaoObrigatoria) {
	...
	protected Query<Object[]> preparar(Session session) throws HQueryException {
		...
		sql.append(" select ");
		sql.append(" prd.prdNumero, ");
		sql.append(" prd.prdDataRealizado, ");
		sql.append(" spd.spdDescricao, ");
		sql.append(" ade.adeNumero, ");
		sql.append(" ade.adeIdentificador, ");
		sql.append(" ade.adePrazo, ");
		sql.append(" ade.adeVlr, ");
		sql.append(" tde.tdeDescricao, ");
		sql.append(" ocp.ocpObs ");
		...
		sql.append(" left join prd.tipoDesconto tde ");
		sql.append(" left join prd.ocorrenciaParcelaPeriodoSet ocp ");
		...
		sql.append(" and usu.usuCodigo ").append(criaClausulaNomeada("idUsuario", idUsuario));
		...
		defineValorClausulaNomeada("idUsuario", idUsuario, query);
		if(!notificaoObrigatoria) {
