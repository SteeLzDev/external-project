...
/**
 * <p>Title: ListaConvenioCorrespondenteDesbloquearQuery</p>
 * <p>Description: Lista os convênios que devem ser desbloqueados para o correspondente
 * caso o usuário queira desbloquear todos os convênios da consignatária para o correspondente.</p>
 ...
 * $Date$
 */
public class ListaConvenioCorrespondenteDesbloquearQuery extends HQuery {
    ...
    public Query<Object[]> preparar(Session session) throws HQueryException {
        ...
        corpoBuilder.append(" and ccr.statusConvenio.scvCodigo = '").append(CodedValues.SCV_INATIVO).append("') ");
