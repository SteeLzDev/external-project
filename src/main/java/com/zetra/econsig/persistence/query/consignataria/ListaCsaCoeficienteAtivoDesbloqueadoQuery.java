 ...
 * <p>Description: Listagem de consignatárias que possuem coeficientes desbloqueados hoje.</p>
 ...
 * $Date$
 */
public class ListaCsaCoeficienteAtivoDesbloqueadoQuery extends HQuery {
    ...
    public Query<Object[]> preparar(Session session) throws HQueryException {
        ...
        corpoBuilder.append(" AND (date_diff(cfa.cftDataIniVig, data_corrente()) = 0)");
