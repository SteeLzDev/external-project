...
/**
 * <p>Title: ListaConsignacaoCancelamentoAprovacaoSaldoQuery</p>
 * <p>Description: Listagem de consignações para cancelamento do processo de compra em virtude do atraso
 * na aprovação pelo servidor do saldo devedor de contratos envolvidos em processo de compra.</p>
 ...
 * $Date$
 */
public class ListaConsignacaoCancelamentoAprovacaoSaldoQuery extends HQuery {
    ...
    public Query<Object[]> preparar(Session session) throws HQueryException {
        ...
        corpoBuilder.append("AND COALESCE(pse194.pseVlr, '0') = '2' ");
