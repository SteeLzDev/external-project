...
public final class TestePerformanceViaArquivo {
    ...
    // args[1] --> Nome do arquivo com matrículas e CPFs separados por ponto e vírgula
    public static void main(String[] args) {
        ...
        if (args == null || args.length != 2) {
            System.out.println("Informe a quantidade de testes (args[0]) e o nome do arquivo de matrículas e CPFs (args[1])");
            return;
        }

        int qtdTestes = Integer.valueOf(args[0]);
        String arqMatriculaCpf = args[1];
        ...
        for (int j = 0; j < qtdTestes; j++) {
            ...
            try {
                ...
                while ((linha = in.readLine()) != null) {
                    ...
                    String comando1 = XML_CONSULTA_MARGEM
                    ...
                    String comando2 = XML_RESERVA_MARGEM
                            .replaceAll("<#CLIENTE#>", cliente)
                            .replaceAll("<#CONVENIO#>", convenio)
                            .replaceAll("<#USUARIO#>", usuario)
                            .replaceAll("<#SENHA#>", senha)
                    ...
                    String comando3 = XML_CONSULTAR_CONSIGNACAO
                            .replaceAll("<#CLIENTE#>", cliente)
                            .replaceAll("<#CONVENIO#>", convenio)
                            .replaceAll("<#USUARIO#>", usuario)
                            .replaceAll("<#SENHA#>", senha)
                    ...
                    String comando4 = XML_CANCELAR_CONSIGNACAO
                            .replaceAll("<#CLIENTE#>", cliente)
                            .replaceAll("<#CONVENIO#>", convenio)
                            .replaceAll("<#USUARIO#>", usuario)
                            .replaceAll("<#SENHA#>", senha)
                    ...
                    try {
                        for (String comando : new String[]{comando1, comando2, comando3, comando4}) {
                            LOG.info(comando);
