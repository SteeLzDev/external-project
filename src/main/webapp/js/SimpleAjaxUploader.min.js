...
ss.SimpleUpload.prototype = {
  ...
  */
  _createInput: function() {
    ...
    // Correção do bug do IE, um elemento com ID='paiElementUpload' deve existir
    // Insere a DIV como primeiro elemento com positio relative, o que deve sobrepor
    // o button em com position absolute.
    div.setAttribute("id", "div" + this._opts.name);
    var paiElementUpload = document.getElementById('paiElementUpload-' + this._opts.name); 
    paiElementUpload.insertBefore(div, paiElementUpload.firstChild);
