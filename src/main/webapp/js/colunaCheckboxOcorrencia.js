...
$("[name='selecionaAcaoSelecionar']").click(function() {
	...
	$(this).parentsUntil("tbody").toggleClass("oculta-ocorrencia");
	...
	$("[name='selecionaAcaoSelecionar']").parentsUntil("tr").removeClass("oculta-ocorrencia");
...
$("#checkAll").click(function() {$('input[type="checkbox"]').prop("checked",function(i, val) {
		if (i != 0) {
			if ($("#checkAll").is(":checked")) {
				...
				$(this).parentsUntil("tbody", ".selecionarLinha").addClass("oculta-ocorrencia");
			} else {
				$(this).parentsUntil("tbody",".selecionarLinha").removeClass("table-checked");
				$("[name='selecionaAcaoSelecionar']").parentsUntil("tr").removeClass("table-checked");
				$(this).parentsUntil("tbody", ".selecionarLinha").removeClass("oculta-ocorrencia");
				$("[name='selecionaAcaoSelecionar']").parentsUntil("tr").removeClass("oculta-ocorrencia");
			}
