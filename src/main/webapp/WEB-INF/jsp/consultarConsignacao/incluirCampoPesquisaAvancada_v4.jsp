      ...
      <form action="<%= TextHelper.forHtmlAttribute(request.getAttribute("acaoFormulario")) %>" method="post" name="formPesqAvancada">
        ...
        <fieldset>
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-12 col-md-6">
              <hl:campoMatriculav4 placeHolder='<%=ApplicationResourcesHelper.getMessage("mensagem.informacao.servidor.matricula", _responsavel)%>' />
            </div>

            <div class="form-group col-sm-12 col-md-6">
              <hl:campoCPFv4 placeHolder='<%=ApplicationResourcesHelper.getMessage("mensagem.informacao.servidor.cpf", _responsavel)%>' classe="form-control"/>
            </div>
            ...
            <div class="row">
              ...
              <% if (_margens != null && _margens.size() > 0) { %>
                <div class="form-group col-sm-12 col-md-6">
                  <label for="ADE_INC_MARGEM"><hl:message key="rotulo.consignacao.incide.margem"/></label>
                	<%= JspHelper.geraCombo(_margens, "ADE_INC_MARGEM", Columns.MAR_CODIGO, Columns.MAR_DESCRICAO, rotuloCampoTodos, null, false, 3, JspHelper.verificaVarQryStr(request, "ADE_INC_MARGEM"), null, false, "form-control") %>
                </div>
              <% } %>
              ...
              <% if (_responsavel.isCseSup()) { %>
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="form-group mt-2" role="radiogroup" aria-labelledby="listarConsignacoesArquivadas">
                    <div class="form-check form-check-inline" >
                      ...
                      <label class="form-check-label labelSemNegrito" for="arquivado_sim"><hl:message key="rotulo.sim"/></label>
                    </div>
                    <div class="form-check form-check-inline" >
                      ...
                      <label class="form-check-label labelSemNegrito" for="arquivado_nao"><hl:message key="rotulo.nao"/></label>
                    </div>
                  </div>
                </div>
              <% } %>
              ...
              <% if (_responsavel.isCsaCor()) { %>
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="form-group" role="radiogroup" aria-labelledby="listarMinhasConsignacoes">
                    <div class="form-check form-check-inline" >
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="form-group mt-2" role="radiogroup" aria-labelledby="integrafolha">
                  <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="ADE_INT_FOLHA" id="ADE_INT_FOLHA_1" value="1" <%= (JspHelper.verificaVarQryStr(request, "ADE_INT_FOLHA").equals("1")) ? " checked " : "" %>/>
                    <label class="form-check-label labelSemNegrito" for="ADE_INT_FOLHA_1"><hl:message key="rotulo.sim"/></label>
                  </div>
                  <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="ADE_INT_FOLHA" id="ADE_INT_FOLHA_0" value="0" <%= (JspHelper.verificaVarQryStr(request, "ADE_INT_FOLHA").equals("0")) ? " checked " : "" %>/>
                    <label class="form-check-label labelSemNegrito" for="ADE_INT_FOLHA_0"><hl:message key="rotulo.nao"/></label>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row" role="radiogroup" aria-labelledby="saldoDevedor">
                    <div class="col-sm-12 col-md-12">
                      <label class="form-check-label" for="infSaldoDevedor_1">
                        ...
                        <span class="text-nowrap labelSemNegrito align-text-top"><hl:message key="mensagem.pesquisa.saldo.solicitado"/></span>
                      </label>
                    </div>
                    <div class="col-sm-12 col-md-12">
                      <label class="form-check-label" for="infSaldoDevedor_2">
                        ...
                        <span class="text-nowrap labelSemNegrito align-text-top"><hl:message key="mensagem.pesquisa.saldo.solicitado.nao.informado"/></span>
                      </label>
                    </div>
                    <div class="col-sm-12 col-md-12">
                      <label class="form-check-label" for="infSaldoDevedor_3">
                        ...
                        <span class="text-nowrap labelSemNegrito align-text-top"><hl:message key="mensagem.pesquisa.saldo.solicitado.informado"/></span>
                      </label>
                    </div>
                    <div class="col-sm-12 col-md-12">
                      <label class="form-check-label formatacao" for="infSaldoDevedor_4">
                        ...
                        <span class="text-nowrap labelSemNegrito align-text-top"><hl:message key="mensagem.pesquisa.saldo.nao.solicitado"/></span>
                      </label>
                    </div>
                  </div>
                </div>
          ...
          <div class="form-check">
            <div class="row" role="radiogroup" aria-labelledby="grupoOrdenacao">
              <div class="col-sm-12 col-md-12">
                  ...
                  <label class="form-check-label align-text-top labelSemNegrito" for="tipoOrdenacao_1"><hl:message key="mensagem.informacao.ordenacao.padrao"/></label>
              </div>
              <div class="col-sm-12 col-md-12">
                  ...
                  <label class="form-check-label align-text-top labelSemNegrito" for="tipoOrdenacao_2"><hl:message key="mensagem.informacao.ordenacao.desconto.folha.asc"/></label>
              </div>
              <div class="col-sm-12 col-md-12">
                  ...
                  <label class="form-check-label align-text-top labelSemNegrito" for="tipoOrdenacao_3"><hl:message key="mensagem.informacao.ordenacao.desconto.folha.desc"/></label>
              </div>
              <div class="col-sm-12 col-md-12">
                  ...
                  <label class="form-check-label align-text-top labelSemNegrito"  for="tipoOrdenacao_4"><hl:message key="mensagem.informacao.ordenacao.desconto.personalizada"/></label>
              </div>
            </div>
          </div>
...
function validaFormPesqAvancada() {
  ...
  <% if (!_responsavel.isSer()) { %>
    ...
    if ((RSE_MATRICULA != null && RSE_MATRICULA.value != '') || 
