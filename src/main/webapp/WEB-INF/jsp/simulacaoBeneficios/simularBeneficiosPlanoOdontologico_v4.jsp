...
<%
  ...
  List<Consignataria> consignatariasOdontologico = (List) request.getAttribute("consignatariasOdontologico");
            ...
            <div class="row">
              <div class="col-sm">
                ...
                <select class="form-control"
                  ...
                  <%
                      for (Consignataria consignataria : consignatariasOdontologico) {
                  %>
                  <option
...
<c:set var="javascript">
  ...
  function fluxoVoltar() { 
	    ...
	    %>
	    	postData('../v3/simulacaoBeneficios?acao=planoSaude&<%=TextHelper.forJavaScript(SynchronizerToken.generateToken4URL(request))%>&RSE_CODIGO=<%=TextHelper.forJavaScript(rseCodigo)%>'); return false;	    <%
	    } 
	    %>
  }
  ...
  function proximo() { 
	  showModal();
	  postData('../v3/simulacaoBeneficios?acao=detalhes&<%=TextHelper.forJavaScript(SynchronizerToken.generateToken4URL(request))%>&RSE_CODIGO=<%=TextHelper.forJavaScript(rseCodigo)%>');
  }
