<%--
* <p>Title: reativarBeneficiarioPlanoSaude_v4</p>
* <p>Description: Reativar Beneficiarios Plano Saude de beneficio Cancelados v4</p>
* <p>Copyright: Copyright (c) 2018</p>
* <p>Company: Nostrum Consultoria e Projetos</p>
* $Author: marcos.nolasco $
* $Revision: 28822 $
* $Date: 2020-03-07 14:24:44 -0300 (sex, 07 fev 2020) $
--%>
...
<%
  ...
  List<ConsignatariaTransferObject> consignatariasPlanoSaude = (List) request.getAttribute("consignatariasPlanoSaude");
...
%>
<c:set var="title">
  <hl:message key="rotulo.reativar.contrato.beneficio.saude.titulo" />
</c:set>
            ...
            <div class="row">
              <div class="col-sm">
                ...
                <select class="form-control"
                  ...
                  <%
                      for (ConsignatariaTransferObject consignataria : consignatariasPlanoSaude) {
                  %>
                  <option
  ...
  function trataErroDadosSimulacao(request, status, error) { 
  	try {
		...
		if (request.status == 500) {
			...
			postData('../v3/reativarBeneficiarioSimulacaoBeneficios?acao=planoSaude&<%=TextHelper.forJavaScript(SynchronizerToken.generateToken4URL(request))%>&RSE_CODIGO=<%=TextHelper.forJavaScript(rseCodigo)%>');
		} else { 
			postData('../v3/carregarPrincipal');
		}	
	} catch (err) {
