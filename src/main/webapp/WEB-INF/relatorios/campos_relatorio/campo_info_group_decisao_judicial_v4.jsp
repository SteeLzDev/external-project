...
<% 
 ...
 %>
          <fieldset class="col-sm-12 col-md-12">
            ...
            <div class="form-check">
              <div class="row">
                ...
                <div class="col-sm-12 col-md-4">
                  <span class="text-nowrap align-text-top">
                    <INPUT class="form-check-input ml-1" TYPE="CHECKBOX" NAME="chkCAMPOS" ID="chkCAMPOS10" TITLE="<hl:message key="rotulo.relatorio.decisao.judicial.periodo"/>" VALUE="<%=TextHelper.forHtmlAttribute(CamposRelatorioSinteticoEnum.CAMPO_DATA_DECISAO_JUDICIAL.getCodigo())%>" <%if (informacoes != null && valueList.contains(CamposRelatorioSinteticoEnum.CAMPO_DATA_DECISAO_JUDICIAL.getCodigo())) {%> checked disabled <%} else if (desabilitado) {%> disabled <%} %> onFocus="SetarEventoMascaraV4(this,'#*200',true);" onClick="atualiza(this.checked, document.forms[0].ORDENACAO, '<hl:message key="rotulo.relatorio.decisao.judicial.periodo"/>', '<%=TextHelper.forHtmlContent(CamposRelatorioSinteticoEnum.CAMPO_DATA_DECISAO_JUDICIAL.getCodigo())%>');" onBlur="fout(this);ValidaMascaraV4(this);">
                    <label class="form-check-label labelSemNegrito ml-1" for="chkCAMPOS10"><hl:message key="rotulo.relatorio.decisao.judicial.periodo"/></label>
                  </span>
                </div>
                <div class="col-sm-12 col-md-4">
                  <span class="text-nowrap align-text-top">
                    <INPUT class="form-check-input ml-1" TYPE="CHECKBOX" NAME="chkCAMPOS" ID="chkCAMPOS11" TITLE="<hl:message key="rotulo.relatorio.decisao.judicial.tipo.justica"/>" VALUE="<%=TextHelper.forHtmlAttribute(CamposRelatorioSinteticoEnum.CAMPO_TIPO_JUSTICA.getCodigo())%>" <%if (informacoes != null && valueList.contains(CamposRelatorioSinteticoEnum.CAMPO_TIPO_JUSTICA.getCodigo())) {%> checked disabled <%} else if (desabilitado) {%> disabled <%} %> onFocus="SetarEventoMascaraV4(this,'#*200',true);" onClick="atualiza(this.checked, document.forms[0].ORDENACAO, '<hl:message key="rotulo.relatorio.decisao.judicial.tipo.justica"/>', '<%=TextHelper.forHtmlContent(CamposRelatorioSinteticoEnum.CAMPO_TIPO_JUSTICA.getCodigo())%>');" onBlur="fout(this);ValidaMascaraV4(this);">
                    <label class="form-check-label labelSemNegrito ml-1" for="chkCAMPOS11"><hl:message key="rotulo.relatorio.decisao.judicial.tipo.justica"/></label>
                  </span>
                </div>
                <div class="col-sm-12 col-md-4">
                  <span class="text-nowrap align-text-top">
                    <INPUT class="form-check-input ml-1" TYPE="CHECKBOX" NAME="chkCAMPOS" ID="chkCAMPOS12" TITLE="<hl:message key="rotulo.relatorio.decisao.judicial.comarca"/>" VALUE="<%=TextHelper.forHtmlAttribute(CamposRelatorioSinteticoEnum.CAMPO_COMARCA_DECISAO_JUDICIAL.getCodigo())%>" <%if (informacoes != null && valueList.contains(CamposRelatorioSinteticoEnum.CAMPO_COMARCA_DECISAO_JUDICIAL.getCodigo())) {%> checked disabled <%} else if (desabilitado) {%> disabled <%} %> onFocus="SetarEventoMascaraV4(this,'#*200',true);" onClick="atualiza(this.checked, document.forms[0].ORDENACAO, '<hl:message key="rotulo.relatorio.decisao.judicial.comarca"/>', '<%=TextHelper.forHtmlContent(CamposRelatorioSinteticoEnum.CAMPO_COMARCA_DECISAO_JUDICIAL.getCodigo())%>');" onBlur="fout(this);ValidaMascaraV4(this);">
                    <label class="form-check-label labelSemNegrito ml-1" for="chkCAMPOS12"><hl:message key="rotulo.relatorio.decisao.judicial.comarca"/></label>
                  </span>
                </div>
              </div>
            </div>
    ...
    <% } %>                           
      ...
      <script type="text/JavaScript">
          function valida_campo_info_group_decisao_judicial() {
              return true;
          }
      </script>        
