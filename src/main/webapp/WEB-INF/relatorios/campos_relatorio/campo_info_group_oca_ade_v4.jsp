...
<% 
 ...
 %>
          <fieldset class="col-sm-12 col-md-12">
            ...
            <div class="form-check">
              <div class="row">
                ...
                <div class="col-sm-12 col-md-4">
                  <span class="text-nowrap align-text-top">
                    <INPUT class="form-check-input ml-1" TYPE="CHECKBOX" NAME="chkCAMPOS" ID="chkCAMPOS10" TITLE="<hl:message key="rotulo.relatorio.periodo.ocorrencia"/>" VALUE="<%=TextHelper.forHtmlAttribute(CamposRelatorioSinteticoEnum.CAMPO_DATA_OCORRENCIA.getCodigo())%>" <%if (informacoes != null && valueList.contains(CamposRelatorioSinteticoEnum.CAMPO_DATA_OCORRENCIA.getCodigo())) {%> checked disabled <%} else if (desabilitado) {%> disabled <%} %> onFocus="SetarEventoMascaraV4(this,'#*200',true);" onClick="atualiza(this.checked, document.forms[0].ORDENACAO, '<hl:message key="rotulo.relatorio.periodo.ocorrencia"/>', '<%=TextHelper.forHtmlContent(CamposRelatorioSinteticoEnum.CAMPO_DATA_OCORRENCIA.getCodigo())%>');" onBlur="fout(this);ValidaMascaraV4(this);">
                    <label class="form-check-label labelSemNegrito ml-1" for="chkCAMPOS10"><hl:message key="rotulo.relatorio.periodo.ocorrencia"/></label>
                  </span>
                </div>
                
                <div class="col-sm-12 col-md-4">
                  <span class="text-nowrap align-text-top">
                    <INPUT class="form-check-input ml-1" TYPE="CHECKBOX" NAME="chkCAMPOS" ID="chkCAMPOS11" TITLE="<hl:message key="rotulo.relatorio.ocorrenciaconsignacao.tipo"/>" VALUE="<%=TextHelper.forHtmlAttribute(CamposRelatorioSinteticoEnum.CAMPO_TIPO_OCORRENCIA.getCodigo())%>" <%if (informacoes != null && valueList.contains(CamposRelatorioSinteticoEnum.CAMPO_TIPO_OCORRENCIA.getCodigo())) {%> checked disabled <%} else if (desabilitado) {%> disabled <%} %> onFocus="SetarEventoMascaraV4(this,'#*200',true);" onClick="atualiza(this.checked, document.forms[0].ORDENACAO, '<hl:message key="rotulo.relatorio.ocorrenciaconsignacao.tipo"/>', '<%=TextHelper.forHtmlContent(CamposRelatorioSinteticoEnum.CAMPO_TIPO_OCORRENCIA.getCodigo())%>');" onBlur="fout(this);ValidaMascaraV4(this);">
                    <label class="form-check-label labelSemNegrito ml-1" for="chkCAMPOS11"><hl:message key="rotulo.relatorio.ocorrenciaconsignacao.tipo"/></label>
                  </span>
                </div>
                
                <div class="col-sm-12 col-md-4">
                  <span class="text-nowrap align-text-top">
                    <INPUT class="form-check-input ml-1" TYPE="CHECKBOX" NAME="chkCAMPOS" ID="chkCAMPOS12" TITLE="<hl:message key="rotulo.relatorio.ocorrenciaconsignacao.tipo.motivo.operacao"/>" VALUE="<%=TextHelper.forHtmlAttribute(CamposRelatorioSinteticoEnum.CAMPO_TIPO_MOTIVO_OPERACAO.getCodigo())%>" <%if (informacoes != null && valueList.contains(CamposRelatorioSinteticoEnum.CAMPO_TIPO_MOTIVO_OPERACAO.getCodigo())) {%> checked disabled <%} else if (desabilitado) {%> disabled <%} %> onFocus="SetarEventoMascaraV4(this,'#*200',true);" onClick="atualiza(this.checked, document.forms[0].ORDENACAO, '<hl:message key="rotulo.relatorio.ocorrenciaconsignacao.tipo.motivo.operacao"/>', '<%=TextHelper.forHtmlContent(CamposRelatorioSinteticoEnum.CAMPO_TIPO_MOTIVO_OPERACAO.getCodigo())%>');" onBlur="fout(this);ValidaMascaraV4(this);">
                    <label class="form-check-label labelSemNegrito ml-1" for="chkCAMPOS12"><hl:message key="rotulo.relatorio.ocorrenciaconsignacao.tipo.motivo.operacao"/></label>
                  </span>
                </div>
                <div class="col-sm-12 col-md-4">
                  <span class="text-nowrap align-text-top">
                    <INPUT class="form-check-input ml-1" TYPE="CHECKBOX" NAME="chkCAMPOS" ID="chkCAMPOS13" TITLE="<hl:message key="rotulo.verba.singular"/>" VALUE="<%=TextHelper.forHtmlAttribute(CamposRelatorioSinteticoEnum.CAMPO_VERBA.getCodigo())%>" <%if (informacoes != null && valueList.contains(CamposRelatorioSinteticoEnum.CAMPO_VERBA.getCodigo())) {%> checked disabled <%} else if (desabilitado) {%> disabled <%} %> onFocus="SetarEventoMascaraV4(this,'#*200',true);" onClick="atualiza(this.checked, document.forms[0].ORDENACAO, '<hl:message key="rotulo.verba.singular"/>', '<%=TextHelper.forHtmlContent(CamposRelatorioSinteticoEnum.CAMPO_VERBA.getCodigo())%>');" onBlur="fout(this);ValidaMascaraV4(this);">
                    <label class="form-check-label labelSemNegrito ml-1" for="chkCAMPOS13"><hl:message key="rotulo.verba.singular"/></label>
                  </span>
                </div>
                <div class="col-sm-12 col-md-4">
                  <span class="text-nowrap align-text-top">
                    <INPUT class="form-check-input ml-1" TYPE="CHECKBOX" NAME="chkCAMPOS" ID="chkCAMPOS14" TITLE="<hl:message key="rotulo.natureza.servico.titulo"/>" VALUE="<%=TextHelper.forHtmlAttribute(CamposRelatorioSinteticoEnum.CAMPO_NATUREZA_SERVICO.getCodigo())%>" <%if (informacoes != null && valueList.contains(CamposRelatorioSinteticoEnum.CAMPO_NATUREZA_SERVICO.getCodigo())) {%> checked disabled <%} else if (desabilitado) {%> disabled <%} %> onFocus="SetarEventoMascaraV4(this,'#*200',true);" onClick="atualiza(this.checked, document.forms[0].ORDENACAO, '<hl:message key="rotulo.natureza.servico.titulo"/>', '<%=TextHelper.forHtmlContent(CamposRelatorioSinteticoEnum.CAMPO_NATUREZA_SERVICO.getCodigo())%>');" onBlur="fout(this);ValidaMascaraV4(this);">
                    <label class="form-check-label labelSemNegrito ml-1" for="chkCAMPOS14"><hl:message key="rotulo.natureza.servico.titulo"/></label>
                  </span>
                </div>
              </div>
            </div>
    ...
    <% } %>                           
        ...
        <script type="text/JavaScript">
         function valida_campo_info_group_oca_ade() {
             return true;
         }
        </script>        
