    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="form-check form-check-inline">
                <input class="form-check-input ml-1" type="radio" name="tarifacaoPorModalidade"
                       id="tarifacaoPorModalidade2" title="<hl:message key="rotulo.sim"/>"
                ...
                <label class="form-check-label labelSemNegrito ml-1 pr-4" for="tarifacaoPorModalidade2"><hl:message
                        key="rotulo.sim"/></label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input ml-1" type="radio" name="tarifacaoPorModalidade"
                       id="tarifacaoPorModalidade1" title="<hl:message key="rotulo.nao"/>"
                       value="false" <%=!JspHelper.verificaVarQryStr(request, "tarifacaoPorModalidade").equals("true") ? "checked" : "" %>
                       onFocus="SetarEventoMascaraV4(this,'#*100',true);"
                       onBlur="fout(this);ValidaMascaraV4(this);" <%=(String)(desabilitado ? "disabled" : "")%> >
                <label class="form-check-label labelSemNegrito ml-1 pr-4" for="tarifacaoPorModalidade1"><hl:message
...
<script type="text/JavaScript">
    function funTarifacaoPorModalidadePage() {
        camposObrigatorios = camposObrigatorios + 'tarifacaoPorModalidade,';

        msgCamposObrigatorios = msgCamposObrigatorios + '<hl:message key="mensagem.informe.por.modalidade"/>,';
    }
...
<script type="text/JavaScript">
    function valida_campo_tarifacao_por_modalidade() {
        return true;
    }
</script>
