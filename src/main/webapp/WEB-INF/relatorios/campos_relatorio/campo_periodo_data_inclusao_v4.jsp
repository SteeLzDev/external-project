...
%>
      ...
      function funPeriodoDataInclusaoPage() {
          if ((periodo == null || periodo.value == '') && (periodoIni == null || periodoIni.value == '') && (periodoFim == null || periodoFim.value == '')) {
                	  
               alert('<hl:message key="mensagem.informe.periodo.ou.data.inicio.data.fim"/>');
               periodo.focus();
               return false;
          }else{
        	  return true;
        ...
        <script type="text/JavaScript">
         function valida_campo_periodo_data_inclusao() {
