...
<% 
   ...
   if (responsavelCsaPage.isCseSupOrg() && csaListCsaPage != null) {
%>
              <div class="form-group col-sm-12 col-md-6">
                <label id="lblConsignataria" for="csaCodigo">${descricoes[recurso]}</label>
                <%=JspHelper.geraCombo(csaListCsaPage, "csaCodigo", fieldValue, fieldLabel, "", "", (TextHelper.isNull(csaCodigo) && !desabilitado), 3, csaCodigo, null, desabilitado, "form-control")%>
              </div>
...
<% } %>
              <script type="text/JavaScript">
              function valida_campo_csa_multiplo() {
                 return true;
              }
              </script>
