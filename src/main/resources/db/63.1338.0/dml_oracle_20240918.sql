...
UPDATE tb_texto_sistema SET TEX_TEXTO = 'Pelo menos um papel deve ser selecionado.' WHERE TEX_CHAVE = 'mensagem.informe.papel.usuario' AND TEX_TEXTO LIKE 'Pelo menos um papel de ser selecionado.';
