...
VALUES ('54', '1', '1', '1', 'Gera arquivo de margem (servico externo) de acordo com data prevista de retorno', 'com.zetra.econsig.job.jobs.GeraArquivoMargemServicoExternoJob', SYSDATE, SYSDATE, NULL);
