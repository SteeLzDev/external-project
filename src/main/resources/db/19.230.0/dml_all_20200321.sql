...
update tb_tipo_param_sist_consignante set  gps_codigo = '1' where tpc_codigo in ('710','715','717');
update tb_tipo_param_sist_consignante set  gps_codigo = '2' where tpc_codigo in ('707');
update tb_tipo_param_sist_consignante set  gps_codigo = '3' where tpc_codigo in ('708','709','712','713','716');


-- 2) CONCEDER A  PERMISSAO DE VISUALIZAR E ALTERAR PARA USUÁRIOS SUP: 

update tb_tipo_param_sist_consignante set tpc_sup_consulta = 'S', tpc_sup_altera = 'S' where tpc_codigo in ('707','708','709','710','712','713','715','716','717');
...
where tpc.tpc_codigo in ('707','708','709','710','712','713','715','716','717');
