...
VALUES ('59', '1', '1', '1', 'Envia notificação para CSAs sobre alteração da regra de convênio', 'com.zetra.econsig.job.jobs.EnviaNotificacaoCsaAlteracaoRegrasConvenioJob', SYSDATE, SYSDATE, NULL);
