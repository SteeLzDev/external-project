...
values ('campo_fun', 'Função', '/relatorios/campos_relatorio/campo_funcao.jsp', 'N');

UPDATE tb_relatorio_filtro SET RFI_SEQUENCIA = RFI_SEQUENCIA + 1 WHERE REL_CODIGO = 'usuarios' AND RFI_SEQUENCIA >= 2;
...
VALUES ('usuarios', 'campo_fun', '1', '1', '1', '1', '1', '0', 2, NULL);