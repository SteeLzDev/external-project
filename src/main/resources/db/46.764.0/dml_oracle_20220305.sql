...
VALUES ('48', '5', '2', '1', 'Confirmação das operações que liberam margem para bloqueio automático de segurança', 'com.zetra.econsig.job.jobs.ConfirmarOperacoesLiberacaoMargemJob', SYSDATE, SYSDATE, NULL); 
