...
SELECT COUNT(TEX_CHAVE) INTO total_chaves FROM tb_texto_sistema WHERE TEX_CHAVE IN ('mobile.mensagem.codigo.unico.enviado.por.email', 'mensagem.mobile.codigo.unico.enviado.por.email');
