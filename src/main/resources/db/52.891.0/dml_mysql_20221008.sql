...
VALUES ('50', '1', '1', '1', 'Bloqueio de Consignatária por CET / Taxa de Juros com data de vigência expirada', 'com.zetra.econsig.job.jobs.BloqueiaCsaPorCetExpiradoJob', CURDATE(), CURDATE(), NULL);