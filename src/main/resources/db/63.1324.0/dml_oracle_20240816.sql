...
VALUES ('57', '1', '1', '1', 'Envia Notificação que a Autorização Irá Vencer', 'com.zetra.econsig.job.jobs.EnviaNotificacaoAutorizacaoIraVencerJob', SYSDATE, SYSDATE, NULL);
