...
VALUES ('58', '1', '1', '1', 'Envia notificação de prazo de expiração de senha', 'com.zetra.econsig.job.jobs.EnviaNotificacaoPrazoExpiracaoSenhaJob', SYSDATE, SYSDATE, NULL);
