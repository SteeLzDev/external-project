...
VALUES ('56', '1', '1', '1', 'Libera margem presa fruto de renegociação para menor', 'com.zetra.econsig.job.jobs.AtualizaMargemRenegociacaoPrazoExpiradoJob', CURDATE(), CURDATE(), NULL);
