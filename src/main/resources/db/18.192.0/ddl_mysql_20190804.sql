/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     02/08/2019 15:00:06                          */
/*==============================================================*/
...
/*==============================================================*/
/* Table: tb_status_bloco_processamento                         */
/*==============================================================*/
create table tb_status_bloco_processamento
(
   SBP_CODIGO           varchar(32) not null,
   SBP_DESCRICAO        varchar(40) not null,
   primary key (SBP_CODIGO)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*==============================================================*/
/* Table: tb_tipo_bloco_processamento                           */
/*==============================================================*/
create table tb_tipo_bloco_processamento
(
   TBP_CODIGO           varchar(32) not null,
   TBP_DESCRICAO        varchar(40) not null,
   primary key (TBP_CODIGO)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
