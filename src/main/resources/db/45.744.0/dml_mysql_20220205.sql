...
DROP TEMPORARY TABLE IF EXISTS tmp_media_margem_folha;
CREATE TEMPORARY TABLE tmp_media_margem_folha (RSE_CODIGO varchar(32), MAR_CODIGO smallint, MEDIA decimal(13,2), primary key (RSE_CODIGO, MAR_CODIGO));
...
WHERE HMA_DATA >= DATE_SUB(CURDATE(), INTERVAL 12 MONTH)
