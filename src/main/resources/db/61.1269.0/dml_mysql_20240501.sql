...
VALUES ('55', '1', '1', '1', 'Verifica se existem ocorrências do histórico de agendamento para exclusão', 'com.zetra.econsig.job.jobs.ExclusaoHistoricoOcorrenciaAgendamentoExternoJob', CURDATE(), CURDATE(), NULL);
